...
var G = {
  ...
  SIGN_IN: G.SIGN_IN,
  SIGN_UP: G.SIGN_UP,
  FORGOTTEN_PASSWORD: G.FORGOTTEN_PASSWORD,
  MAGIC_LINK: G.MAGIC_LINK,
...
var In = {
    ...
    const b = (C) => {
      for (u in C) {
        ...
        for (c of ae) {
          ...
          if (I && (k = u.slice(1) in r.media ? "@media " + r.media[u.slice(1)] : u, u = k.replace(/\(\s*([\w-]+)\s*(=|<|<=|>|>=)\s*([\w-]+)\s*(?:(<|<=|>|>=)\s*([\w-]+)\s*)?\)/g, (R, W, K, ee, D, J) => {
            const ne = ut.test(W), fe = 0.0625 * (ne ? -1 : 1), [he, ze] = ne ? [ee, W] : [W, ee];
            return "(" + (K[0] === "=" ? "" : K[0] === ">" === ne ? "max-" : "min-") + he + ":" + (K[0] !== "=" && K.length === 1 ? ze.replace(ut, (Qe, Pe, Ee) => Number(Pe) + fe * (K === ">" ? 1 : -1) + Ee) : ze) + (D ? ") and (" + (D[0] === ">" ? "min-" : "max-") + he + ":" + (D.length === 1 ? J.replace(ut, (Qe, Pe, Ee) => Number(Pe) + fe * (D === ">" ? -1 : 1) + Ee) : J) : "") + ")";
          })), le) {
            const R = I ? h.concat(u) : [...h], W = I ? [...g] : Vn(g, u.split(On));
            l !== void 0 && o(Zt(...l)), l = void 0, p(c, W, R);
          } else
            l === void 0 && (l = [[], g, h]), u = I || u.charCodeAt(0) !== 36 ? u : `--${ie(r.prefix)}${u.slice(1).replace(/\$/g, "-")}`, c = le ? c : typeof c == "number" ? c && Z in Nn ? String(c) + "px" : String(c) : Qt(jn(Z, c ?? ""), r.prefix, r.themeMap[Z]), l[0].push(`${I ? `${u} ` : `${gt(u)}:`}${c}`);
        }
      }
      var k, _;
    };
  ...
  const l = `${ie(o.prefix)}c-${_e(r)}`, m = [], d = [], p = /* @__PURE__ */ Object.create(null), s = [];
  for (const u in n)
    p[u] = String(n[u]);
  ...
  const [r, o, l, m] = Yn(t.composers), d = typeof t.type == "function" || t.type.$$typeof ? ((h) => {
    ...
    for (const [_, I, ae, Z] of t.composers) {
      n.rules.styled.cache.has(_) || (n.rules.styled.cache.add(_), Ae(I, [`.${_}`], [], a, (W) => {
        p.styled.apply(W);
      }));
      const le = Yt(ae, b, a.media), R = Yt(Z, b, a.media, !0);
      for (const W of le)
        if (W !== void 0)
          for (const [K, ee, D] of W) {
            const J = `${_}-${_e(ee)}-${K}`;
            C.add(J);
            const ne = (D ? n.rules.resonevar : n.rules.onevar).cache, fe = D ? p.resonevar : p.onevar;
            ne.has(J) || (ne.add(J), Ae(ee, [`.${J}`], [], a, (he) => {
              fe.apply(he);
            }));
          }
      for (const W of R)
        if (W !== void 0)
          for (const [K, ee] of W) {
            const D = `${_}-${_e(ee)}-${K}`;
            C.add(D), n.rules.allvar.cache.has(D) || (n.rules.allvar.cache.add(D), Ae(ee, [`.${D}`], [], a, (J) => {
              p.allvar.apply(J);
            }));
          }
    }
  ...
  get variable() {
    return "--" + ie(this.prefix) + ie(this.scale) + this.token;
  }
  toString() {
  ...
  const o = `.${n = (n = typeof n == "string" ? n : "") || `${ie(a.prefix)}t-${_e(r)}`}`, l = {}, m = [];
  for (const p in r) {
    l[p] = {};
    for (const s in r[p]) {
      const g = `--${ie(a.prefix)}${p}-${s}`, h = Qt(String(r[p][s]), a.prefix, p);
...
Xe.exports;
(function(a, t) {
  var n = 200, r = "__lodash_hash_undefined__", o = 9007199254740991, l = "[object Arguments]", m = "[object Array]", d = "[object Boolean]", p = "[object Date]", s = "[object Error]", g = "[object Function]", h = "[object GeneratorFunction]", u = "[object Map]", c = "[object Number]", b = "[object Object]", C = "[object Promise]", k = "[object RegExp]", _ = "[object Set]", I = "[object String]", ae = "[object Symbol]", Z = "[object WeakMap]", le = "[object ArrayBuffer]", R = "[object DataView]", W = "[object Float32Array]", K = "[object Float64Array]", ee = "[object Int8Array]", D = "[object Int16Array]", J = "[object Int32Array]", ne = "[object Uint8Array]", fe = "[object Uint8ClampedArray]", he = "[object Uint16Array]", ze = "[object Uint32Array]", Qe = /[\\^$.*+?()[\]{}|]/g, Pe = /\w*$/, Ee = /^\[object .+?Constructor\]$/, ta = /^(?:0|[1-9]\d*)$/, V = {};
  V[l] = V[m] = V[le] = V[R] = V[d] = V[p] = V[W] = V[K] = V[ee] = V[D] = V[J] = V[u] = V[c] = V[b] = V[k] = V[_] = V[I] = V[ae] = V[ne] = V[fe] = V[he] = V[ze] = !0, V[s] = V[g] = V[Z] = !1;
  var aa = typeof Ye == "object" && Ye && Ye.Object === Object && Ye, na = typeof self == "object" && self && self.Object === Object && self, re = aa || na || Function("return this")(), _t = t && !t.nodeType && t, yt = _t && !0 && a && !a.nodeType && a, ra = yt && yt.exports === _t;
  function oa(e, i) {
  ...
  function sa(e, i) {
    for (var f = -1, S = i.length, F = e.length; ++f < S; )
      e[F + f] = i[f];
    return e;
  }
  function wt(e, i, f, S) {
    var F = -1, H = e ? e.length : 0;
    for (S && H && (f = e[++F]); ++F < H; )
      f = i(f, e[F], F, e);
    return f;
  }
  ...
  var ua = Array.prototype, da = Function.prototype, De = Object.prototype, tt = re["__core-js_shared__"], $t = function() {
  ...
  ), Bt = ra ? re.Buffer : void 0, Tt = re.Symbol, Mt = re.Uint8Array, ha = et(Object.getPrototypeOf, Object), ga = Object.create, ma = De.propertyIsEnumerable, va = ua.splice, xt = Object.getOwnPropertySymbols, ba = Bt ? Bt.isBuffer : void 0, _a = et(Object.keys, Object), at = Me(re, "DataView"), Ve = Me(re, "Map"), nt = Me(re, "Promise"), rt = Me(re, "Set"), ot = Me(re, "WeakMap"), je = Me(Object, "create"), ya = ve(at), wa = ve(Ve), Ca = ve(nt), Sa = ve(rt), ka = ve(ot), It = Tt ? Tt.prototype : void 0, At = It ? It.valueOf : void 0;
  function ge(e) {
  ...
  oe.prototype.clear = xa, oe.prototype.delete = Ia, oe.prototype.get = Aa, oe.prototype.has = za, oe.prototype.set = Pa;
  function Be(e) {
    var i = -1, f = e ? e.length : 0;
    for (this.clear(); ++i < f; ) {
      var S = e[i];
  ...
  function Ua(e, i) {
    var f = st(e) || mn(e) ? ca(e.length, String) : [], S = f.length, F = !!S;
    for (var H in e)
      (i || se.call(e, H)) && !(F && (H == "length" || dn(H, S))) && f.push(H);
    return f;
  }
  function zt(e, i, f) {
    var S = e[i];
  ...
  function it(e, i, f, S, F, H, X) {
    var q;
    if (S && (q = H ? S(e, F, H, X) : S(e)), q !== void 0)
      return q;
    if (!Ze(e))
      return e;
    var Ft = st(e);
  ...
  function Pt(e, i, f, S) {
    f || (f = {});
    for (var F = -1, H = i.length; ++F < H; ) {
      var X = i[F], q = S ? S(f[X], e[X], X, f, e) : void 0;
  ...
  (at && me(new at(new ArrayBuffer(1))) != R || Ve && me(new Ve()) != u || nt && me(nt.resolve()) != C || rt && me(new rt()) != _ || ot && me(new ot()) != Z) && (me = function(e) {
...
var lr = Xe.exports;
const Ke = /* @__PURE__ */ ir(lr), de = Symbol("AuthView"), sr = Symbol("UserContextProvider"), cr = /* @__PURE__ */ N({
    ...
    const n = a, r = z(""), o = z(""), l = z(""), m = z(""), d = z(!1), { authView: p, setAuthView: s } = Le(de), g = j(
      ...
      switch (l.value = "", m.value = "", d.value = !0, h("auth:submit", {
        ...
        case "sign_in":
          ...
          break;
        case "sign_up":
          n.redirectTo, n.additionalData && n.additionalData;
          const {
            data: { user: _, session: I },
            error: ae
          ...
          ae ? (l.value = ae.message, h("auth:error", ae)) : _ && !I && (m.value = (C = (b = n.i18n) == null ? void 0 : b.sign_up) == null ? void 0 : C.confirmation_text), d.value = !1;
      }
    };
    return dt(
      () => p.value,
      ...
      A(v(te), {
        ...
        default: $(() => [
          ...
          c.showLinks ? (y(), L(v(te), {
            ...
            default: $(() => [
              v(p) === v(G).SIGN_IN && c.magicLink ? (y(), L(v(be), {
                key: 0,
                href: "#auth-magic-link",
                appearance: c.appearance,
                onClick: b[2] || (b[2] = Y((C) => v(s)(v(G).MAGIC_LINK), ["prevent"]))
              }, {
                default: $(() => {
                  var C, k;
                  return [
              ...
              v(p) === v(G).SIGN_IN ? (y(), L(v(be), {
                key: 1,
                href: "#auth-forgot-password",
                appearance: c.appearance,
                onClick: b[3] || (b[3] = Y((C) => v(s)(v(G).FORGOTTEN_PASSWORD), ["prevent"]))
              }, {
                default: $(() => {
                  var C, k;
                  return [
              ...
              v(p) === v(G).SIGN_IN ? (y(), L(v(be), {
                ...
                href: "#auth-sign-up",
                appearance: c.appearance,
                onClick: b[4] || (b[4] = Y((C) => v(s)(v(G).SIGN_UP), ["prevent"]))
              }, {
                default: $(() => {
                  var C, k;
                  return [
                ...
                href: "#auth-sign-in",
                appearance: c.appearance,
                onClick: b[5] || (b[5] = Y((C) => v(s)(v(G).SIGN_IN), ["prevent"]))
              }, {
                default: $(() => {
                  var C, k;
                  return [
...
const Vo = /* @__PURE__ */ O(zo, [["render", Eo]]), jo = /* @__PURE__ */ N({
  __name: "Icons",
  props: {
    name: {}
  },
      ...
      A(v(te), {
        ...
        default: $(() => [
          ...
          h.showLinks ? (y(), L(v(be), {
            ...
            href: "#auth-sign-in",
            appearance: h.appearance,
            onClick: u[1] || (u[1] = Y((c) => v(p)(v(G).SIGN_IN), ["prevent"]))
          }, {
            default: $(() => {
              var c, b;
              return [
        ...
        default: $(() => {
          ...
          return [
            ...
            g.showLinks ? (y(), L(v(be), {
              ...
              href: "#auth-sign-in",
              appearance: g.appearance,
              onClick: h[1] || (h[1] = Y((c) => v(d)(v(G).SIGN_IN), ["prevent"]))
            }, {
              default: $(() => {
                var c, b;
                return [
...
}), Uo = ["id"], Go = { key: 0 }, Zo = { key: 1 }, qo = /* @__PURE__ */ N({
  __name: "VerifyOtp",
  props: {
    appearance: {},
    supabaseClient: {},
        ...
        default: $(() => {
          ...
          return [
            ...
            u.showLinks ? (y(), L(v(be), {
              ...
              href: "#auth-sign-in",
              appearance: u.appearance,
              onClick: c[3] || (c[3] = Y((_) => v(s)(v(G).SIGN_IN), ["prevent"]))
            }, {
              default: $(() => {
                var _, I;
                return [
