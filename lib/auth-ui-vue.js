import { defineComponent as W, useAttrs as ye, computed as R, openBlock as y, createBlock as B, resolveDynamicComponent as we, mergeProps as Ce, unref as v, withCtx as $, renderSlot as ue, createElementBlock as x, normalizeClass as Sn, normalizeStyle as kn, inject as $n, ref as z, watch as dt, withModifiers as K, createVNode as A, createElementVNode as T, createTextVNode as I, toDisplayString as M, createCommentVNode as P, createStaticVNode as Ne, onMounted as Jt, provide as Xt, h as Bn, Fragment as Fe, renderList as Ln } from "vue";
var q = {
  SIGN_IN: "sign_in",
  SIGN_UP: "sign_up",
...
}, Tn = "supabase-auth-ui", In = {
  // interfaces
  ROOT: "root",
  SIGN_IN: q.SIGN_IN,
  SIGN_UP: q.SIGN_UP,
  FORGOTTEN_PASSWORD: q.FORGOTTEN_PASSWORD,
  MAGIC_LINK: q.MAGIC_LINK,
  UPDATE_PASSWORD: q.UPDATE_PASSWORD,
  // ui
  anchor: "ui-anchor",
  button: "ui-button",
...
var xn = {
  ...
  for (const t in a)
    return !0;
  return !1;
}, { hasOwnProperty: Pn } = Object.prototype, gt = (a) => a.includes("-") ? a : a.replace(/[A-Z]/g, (t) => "-" + t.toLowerCase()), En = /\s+(?![^()]*\))/, xe = (a) => (t) => a(...typeof t == "string" ? String(t).split(En) : [t]), Gt = { appearance: (a) => ({ WebkitAppearance: a, appearance: a }), backfaceVisibility: (a) => ({ WebkitBackfaceVisibility: a, backfaceVisibility: a }), backdropFilter: (a) => ({ WebkitBackdropFilter: a, backdropFilter: a }), backgroundClip: (a) => ({ WebkitBackgroundClip: a, backgroundClip: a }), boxDecorationBreak: (a) => ({ WebkitBoxDecorationBreak: a, boxDecorationBreak: a }), clipPath: (a) => ({ WebkitClipPath: a, clipPath: a }), content: (a) => ({ content: a.includes('"') || a.includes("'") || /^([A-Za-z]+\([^]*|[^]*-quote|inherit|initial|none|normal|revert|unset)$/.test(a) ? a : `"${a}"` }), hyphens: (a) => ({ WebkitHyphens: a, hyphens: a }), maskImage: (a) => ({ WebkitMaskImage: a, maskImage: a }), maskSize: (a) => ({ WebkitMaskSize: a, maskSize: a }), tabSize: (a) => ({ MozTabSize: a, tabSize: a }), textSizeAdjust: (a) => ({ WebkitTextSizeAdjust: a, textSizeAdjust: a }), userSelect: (a) => ({ WebkitUserSelect: a, userSelect: a }), marginBlock: xe((a, t) => ({ marginBlockStart: a, marginBlockEnd: t || a })), marginInline: xe((a, t) => ({ marginInlineStart: a, marginInlineEnd: t || a })), maxSize: xe((a, t) => ({ maxBlockSize: a, maxInlineSize: t || a })), minSize: xe((a, t) => ({ minBlockSize: a, minInlineSize: t || a })), paddingBlock: xe((a, t) => ({ paddingBlockStart: a, paddingBlockEnd: t || a })), paddingInline: xe((a, t) => ({ paddingInlineStart: a, paddingInlineEnd: t || a })) }, ut = /([\d.]+)([^]*)/, Vn = (a, t) => a.length ? a.reduce((n, r) => (n.push(...t.map((o) => o.includes("&") ? o.replace(/&/g, /[ +>|~]/.test(r) && /&.*&/.test(o) ? `:is(${r})` : r) : r + " " + o)), n), []) : t, jn = (a, t) => a in On && typeof t == "string" ? t.replace(/^((?:[^]*[^\w-])?)(fit-content|stretch)((?:[^\w-][^]*)?)$/, (n, r, o, l) => r + (o === "stretch" ? `-moz-available${l};${gt(a)}:${r}-webkit-fill-available` : `-moz-fit-content${l};${gt(a)}:${r}fit-content`) + l) : String(t), On = { blockSize: 1, height: 1, inlineSize: 1, maxBlockSize: 1, maxHeight: 1, maxInlineSize: 1, maxWidth: 1, minBlockSize: 1, minHeight: 1, minInlineSize: 1, minWidth: 1, width: 1 }, le = (a) => a ? a + "-" : "", Qt = (a, t, n) => a.replace(/([+-])?((?:\d+(?:\.\d*)?|\.\d+)(?:[Ee][+-]?\d+)?)?(\$|--)([$\w-]+)/g, (r, o, l, m, d) => m == "$" == !!l ? r : (o || m == "--" ? "calc(" : "") + "var(--" + (m === "$" ? le(t) + (d.includes("$") ? "" : le(n)) + d.replace(/\$/g, "-") : d) + ")" + (o || m == "--" ? "*" + (o || "") + (l || "1") + ")" : "")), Rn = /\s*,\s*(?![^()]*\))/, Fn = Object.prototype.toString, Ae = (a, t, n, r, o) => {
  let l, m, d;
  const p = (s, g, h) => {
    let u, c;
    const b = (C) => {
      for (u in C) {
        const L = u.charCodeAt(0) === 64, H = L && Array.isArray(C[u]) ? C[u] : [C[u]];
        for (c of H) {
          const j = /[A-Z]/.test(_ = u) ? _ : _.replace(/-[^]/g, (O) => O[1].toUpperCase()), te = typeof c == "object" && c && c.toString === Fn && (!r.utils[j] || !g.length);
          if (j in r.utils && !te) {
            const O = r.utils[j];
            if (O !== m) {
              m = O, b(O(c)), m = null;
          ...
          if (L && (k = u.slice(1) in r.media ? "@media " + r.media[u.slice(1)] : u, u = k.replace(/\(\s*([\w-]+)\s*(=|<|<=|>|>=)\s*([\w-]+)\s*(?:(<|<=|>|>=)\s*([\w-]+)\s*)?\)/g, (O, D, J, ae, U, X) => {
            const re = ut.test(D), fe = 0.0625 * (re ? -1 : 1), [he, ze] = re ? [ae, D] : [D, ae];
            return "(" + (J[0] === "=" ? "" : J[0] === ">" === re ? "max-" : "min-") + he + ":" + (J[0] !== "=" && J.length === 1 ? ze.replace(ut, (Qe, Pe, Ee) => Number(Pe) + fe * (J === ">" ? 1 : -1) + Ee) : ze) + (U ? ") and (" + (U[0] === ">" ? "min-" : "max-") + he + ":" + (U.length === 1 ? X.replace(ut, (Qe, Pe, Ee) => Number(Pe) + fe * (U === ">" ? -1 : 1) + Ee) : X) : "") + ")";
          })), te) {
            const O = L ? h.concat(u) : [...h], D = L ? [...g] : Vn(g, u.split(Rn));
            l !== void 0 && o(Zt(...l)), l = void 0, p(c, D, O);
          } else
            l === void 0 && (l = [[], g, h]), u = L || u.charCodeAt(0) !== 36 ? u : `--${le(r.prefix)}${u.slice(1).replace(/\$/g, "-")}`, c = te ? c : typeof c == "number" ? c && j in Nn ? String(c) + "px" : String(c) : Qt(jn(j, c ?? ""), r.prefix, r.themeMap[j]), l[0].push(`${L ? `${u} ` : `${gt(u)}:`}${c}`);
        }
      }
      var k, _;
    };
  ...
  return t;
})(5381, JSON.stringify(a)) >>> 0), Re = ["themed", "global", "styled", "onevar", "resonevar", "allvar", "inline"], Wn = (a) => {
  ...
  const n = () => {
    ...
    for (const d of o)
      if (Wn(d)) {
        for (let p = 0, s = d.cssRules; s[p]; ++p) {
          ...
          if (!u.startsWith("--sxs"))
            continue;
          const c = u.slice(14, -3).trim().split(/\s+/), b = Re[c[0]];
    ...
    for (let d = Re.length - 1; d >= 0; --d) {
      const p = Re[d];
      if (!m[p]) {
        const s = Re[d + 1], g = m[s] ? m[s].index : l.cssRules.length;
  ...
  const l = `${le(o.prefix)}c-${_e(r)}`, m = [], d = [], p = /* @__PURE__ */ Object.create(null), s = [];
  for (const u in n)
    p[u] = String(n[u]);
  ...
  const [r, o, l, m] = Yn(t.composers), d = typeof t.type == "function" || t.type.$$typeof ? ((h) => {
    function u() {
      for (let c = 0; c < u[Oe].length; c++) {
        const [b, C] = u[Oe][c];
        h.rules[b].apply(C);
      }
      return u[Oe] = [], null;
    }
    return u[Oe] = [], u.rules = {}, Re.forEach((c) => u.rules[c] = { apply: (b) => u[Oe].push([c, b]) }), u;
    ...
    for (const _ in l)
      if (delete c[_], _ in h) {
        let L = h[_];
        typeof L == "object" && L ? b[_] = { "@initial": l[_], ...L } : (L = String(L), b[_] = L !== "undefined" || m.has(_) ? L : l[_]);
      } else
        b[_] = l[_];
    const C = /* @__PURE__ */ new Set([...o]);
    for (const [_, L, H, j] of t.composers) {
      n.rules.styled.cache.has(_) || (n.rules.styled.cache.add(_), Ae(L, [`.${_}`], [], a, (D) => {
        p.styled.apply(D);
      }));
      const te = Yt(H, b, a.media), O = Yt(j, b, a.media, !0);
      for (const D of te)
        if (D !== void 0)
          for (const [J, ae, U] of D) {
            const X = `${_}-${_e(ae)}-${J}`;
            C.add(X);
            const re = (U ? n.rules.resonevar : n.rules.onevar).cache, fe = U ? p.resonevar : p.onevar;
            re.has(X) || (re.add(X), Ae(ae, [`.${X}`], [], a, (he) => {
              fe.apply(he);
            }));
          }
      for (const D of O)
        if (D !== void 0)
          for (const [J, ae] of D) {
            const U = `${_}-${_e(ae)}-${J}`;
            C.add(U), n.rules.allvar.cache.has(U) || (n.rules.allvar.cache.add(U), Ae(ae, [`.${U}`], [], a, (X) => {
              p.allvar.apply(X);
            }));
          }
    }
    if (typeof u == "object" && u) {
      ...
      C.add(_), n.rules.inline.cache.has(_) || (n.rules.inline.cache.add(_), Ae(u, [`.${_}`], [], a, (L) => {
        p.inline.apply(L);
      }));
    }
  ...
  get variable() {
    return "--" + le(this.prefix) + le(this.scale) + this.token;
  }
  toString() {
  ...
  const o = `.${n = (n = typeof n == "string" ? n : "") || `${le(a.prefix)}t-${_e(r)}`}`, l = {}, m = [];
  for (const p in r) {
    l[p] = {};
    for (const s in r[p]) {
      const g = `--${le(a.prefix)}${p}-${s}`, h = Qt(String(r[p][s]), a.prefix, p);
...
Xe.exports;
(function(a, t) {
  var n = 200, r = "__lodash_hash_undefined__", o = 9007199254740991, l = "[object Arguments]", m = "[object Array]", d = "[object Boolean]", p = "[object Date]", s = "[object Error]", g = "[object Function]", h = "[object GeneratorFunction]", u = "[object Map]", c = "[object Number]", b = "[object Object]", C = "[object Promise]", k = "[object RegExp]", _ = "[object Set]", L = "[object String]", H = "[object Symbol]", j = "[object WeakMap]", te = "[object ArrayBuffer]", O = "[object DataView]", D = "[object Float32Array]", J = "[object Float64Array]", ae = "[object Int8Array]", U = "[object Int16Array]", X = "[object Int32Array]", re = "[object Uint8Array]", fe = "[object Uint8ClampedArray]", he = "[object Uint16Array]", ze = "[object Uint32Array]", Qe = /[\\^$.*+?()[\]{}|]/g, Pe = /\w*$/, Ee = /^\[object .+?Constructor\]$/, ta = /^(?:0|[1-9]\d*)$/, V = {};
  V[l] = V[m] = V[te] = V[O] = V[d] = V[p] = V[D] = V[J] = V[ae] = V[U] = V[X] = V[u] = V[c] = V[b] = V[k] = V[_] = V[L] = V[H] = V[re] = V[fe] = V[he] = V[ze] = !0, V[s] = V[g] = V[j] = !1;
  var aa = typeof Ye == "object" && Ye && Ye.Object === Object && Ye, na = typeof self == "object" && self && self.Object === Object && self, oe = aa || na || Function("return this")(), _t = t && !t.nodeType && t, yt = _t && !0 && a && !a.nodeType && a, ra = yt && yt.exports === _t;
  function oa(e, i) {
  ...
  var ua = Array.prototype, da = Function.prototype, De = Object.prototype, tt = oe["__core-js_shared__"], $t = function() {
    var e = /[^.]+$/.exec(tt && tt.keys && tt.keys.IE_PROTO || "");
    return e ? "Symbol(src)_1." + e : "";
  }(), Bt = da.toString, se = De.hasOwnProperty, He = De.toString, fa = RegExp(
    "^" + Bt.call(se).replace(Qe, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), Lt = ra ? oe.Buffer : void 0, Tt = oe.Symbol, It = oe.Uint8Array, ha = et(Object.getPrototypeOf, Object), ga = Object.create, ma = De.propertyIsEnumerable, va = ua.splice, Mt = Object.getOwnPropertySymbols, ba = Lt ? Lt.isBuffer : void 0, _a = et(Object.keys, Object), at = Ie(oe, "DataView"), Ve = Ie(oe, "Map"), nt = Ie(oe, "Promise"), rt = Ie(oe, "Set"), ot = Ie(oe, "WeakMap"), je = Ie(Object, "create"), ya = ve(at), wa = ve(Ve), Ca = ve(nt), Sa = ve(rt), ka = ve(ot), xt = Tt ? Tt.prototype : void 0, At = xt ? xt.valueOf : void 0;
  function ge(e) {
  ...
  ge.prototype.clear = $a, ge.prototype.delete = Ba, ge.prototype.get = La, ge.prototype.has = Ta, ge.prototype.set = Ia;
  function ie(e) {
    var i = -1, f = e ? e.length : 0;
    for (this.clear(); ++i < f; ) {
      var S = e[i];
  ...
  ie.prototype.clear = Ma, ie.prototype.delete = xa, ie.prototype.get = Aa, ie.prototype.has = za, ie.prototype.set = Pa;
  function Le(e) {
    var i = -1, f = e ? e.length : 0;
    for (this.clear(); ++i < f; ) {
      var S = e[i];
  ...
  Le.prototype.clear = Ea, Le.prototype.delete = Va, Le.prototype.get = ja, Le.prototype.has = Oa, Le.prototype.set = Ra;
  function Te(e) {
  ...
  function Ua(e, i) {
    ...
    for (var G in e)
      (i || se.call(e, G)) && !(N && (G == "length" || dn(G, S))) && f.push(G);
    return f;
  }
  function zt(e, i, f) {
    var S = e[i];
  ...
  function it(e, i, f, S, N, G, Q) {
    var Y;
    if (S && (Y = G ? S(e, N, G, Q) : S(e)), Y !== void 0)
      return Y;
    if (!Ze(e))
      return e;
    var Ft = st(e);
    ...
    return la(Dt || e, function(pt, qe) {
      Dt && (qe = pt, pt = e[qe]), zt(Y, qe, it(pt, i, f, S, qe, e, Q));
    }), Y;
  }
  function Za(e) {
    return Ze(e) ? ga(e) : {};
  ...
  function lt(e) {
    ...
    return new It(i).set(new It(e)), i;
  }
  function Qa(e, i) {
  ...
  function Pt(e, i, f, S) {
    ...
    for (var N = -1, G = i.length; ++N < G; ) {
      var Q = i[N], Y = S ? S(f[Q], e[Q], Q, f, e) : void 0;
      zt(f, Q, Y === void 0 ? e[Q] : Y);
    }
    return f;
  }
  function ln(e, i) {
  ...
  var Et = Mt ? et(Mt, Object) : wn, me = Ya;
  (at && me(new at(new ArrayBuffer(1))) != O || Ve && me(new Ve()) != u || nt && me(nt.resolve()) != C || rt && me(new rt()) != _ || ot && me(new ot()) != j) && (me = function(e) {
  ...
  function Ot(e) {
    return e != null && _n(e.length) && !Rt(e);
  }
  function vn(e) {
    return yn(e) && Ot(e);
  }
...
const Ke = /* @__PURE__ */ ir(lr), de = Symbol("AuthView"), sr = Symbol("UserContextProvider"), cr = /* @__PURE__ */ W({
  ...
  setup(a) {
    ...
    return (o, l) => (y(), B(we("div"), Ce(v(n), { class: r.value }), {
      default: $(() => [
        ue(o.$slots, "default")
      ]),
      _: 3
...
const fr = ["id"], hr = /* @__PURE__ */ W({
  ...
  setup(a, { emit: t }) {
    const n = a, r = z(""), o = z(""), l = z(""), m = z(""), d = z(!1), { authView: p, setAuthView: s } = Be(de), g = R(
      () => {
        var c;
      ...
      switch (l.value = "", m.value = "", d.value = !0, h("auth:submit", {
        ...
        case "sign_up":
          ...
          j ? (l.value = j.message, h("auth:error", j)) : L && !H && (m.value = (C = (b = n.i18n) == null ? void 0 : b.sign_up) == null ? void 0 : C.confirmation_text), d.value = !1;
      }
    };
    return dt(
      () => p.value,
        ...
        default: $(() => [
                ...
                T("div", null, [
                  A(v(pe), {
                    ...
                    default: $(() => {
                      var _;
                      return [
                        I(M((_ = g.value) == null ? void 0 : _.email_label), 1)
                      ];
                    }),
                    _: 1
                  }, 8, ["appearance"]),
                ...
                T("div", null, [
                  A(v(pe), {
                    ...
                    default: $(() => {
                      var _;
                      return [
                        I(M((_ = g.value) == null ? void 0 : _.password_label), 1)
                      ];
                    }),
                    _: 1
                  }, 8, ["appearance"]),
          ...
          A(v($e), {
            ...
            default: $(() => {
              var C, k;
              return [
                I(M(d.value ? (C = g.value) == null ? void 0 : C.loading_button_label : (k = g.value) == null ? void 0 : k.button_label), 1)
              ];
            }),
            _: 1
          }, 8, ["loading", "appearance"]),
          c.showLinks ? (y(), B(v(ne), {
            key: 0,
            direction: "vertical",
            gap: "small",
            appearance: c.appearance
            ...
            default: $(() => [
              v(p) === v(q).SIGN_IN && c.magicLink ? (y(), B(v(be), {
                key: 0,
                href: "#auth-magic-link",
                appearance: c.appearance,
                onClick: b[2] || (b[2] = K((C) => v(s)(v(q).MAGIC_LINK), ["prevent"]))
              }, {
                default: $(() => {
                  var C, k;
                  return [
                    I(M((k = (C = c.i18n) == null ? void 0 : C.magic_link) == null ? void 0 : k.link_text), 1)
                  ];
                }),
                _: 1
              }, 8, ["appearance"])) : P("", !0),
              v(p) === v(q).SIGN_IN ? (y(), B(v(be), {
                key: 1,
                href: "#auth-forgot-password",
                appearance: c.appearance,
                onClick: b[3] || (b[3] = K((C) => v(s)(v(q).FORGOTTEN_PASSWORD), ["prevent"]))
              }, {
                default: $(() => {
                  var C, k;
                  return [
                    I(M((k = (C = c.i18n) == null ? void 0 : C.forgotten_password) == null ? void 0 : k.link_text), 1)
                  ];
                }),
                _: 1
              }, 8, ["appearance"])) : P("", !0),
              v(p) === v(q).SIGN_IN ? (y(), B(v(be), {
                ...
                href: "#auth-sign-up",
                appearance: c.appearance,
                onClick: b[4] || (b[4] = K((C) => v(s)(v(q).SIGN_UP), ["prevent"]))
              }, {
                default: $(() => {
                  var C, k;
                  return [
                    I(M((k = (C = c.i18n) == null ? void 0 : C.sign_up) == null ? void 0 : k.link_text), 1)
                  ];
                }),
                _: 1
              }, 8, ["appearance"])) : (y(), B(v(be), {
                key: 3,
                href: "#auth-sign-in",
                appearance: c.appearance,
                onClick: b[5] || (b[5] = K((C) => v(s)(v(q).SIGN_IN), ["prevent"]))
              }, {
                default: $(() => {
                  var C, k;
                  return [
                    I(M((k = (C = c.i18n) == null ? void 0 : C.sign_in) == null ? void 0 : k.link_text), 1)
                  ];
                }),
                _: 1
              }, 8, ["appearance"]))
...
const br = /* @__PURE__ */ F(gr, [["render", vr]]), _r = {}, yr = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 48 48",
  width: "21px",
  height: "21px"
...
const Cr = /* @__PURE__ */ F(_r, [["render", wr]]), Sr = {}, kr = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 48 48",
  width: "21px",
  height: "21px"
...
const Br = /* @__PURE__ */ F(Sr, [["render", $r]]), Lr = {}, Tr = {
  fill: "gray",
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  width: "21px",
...
const Mr = /* @__PURE__ */ F(Lr, [["render", Ir]]), xr = {}, Ar = {
  xmlns: "http://www.w3.org/2000/svg",
  width: "21.34",
  height: "21",
  viewBox: "0 0 256 384"
...
const Pr = /* @__PURE__ */ F(xr, [["render", zr]]), Er = {}, Vr = {
  fill: "gray",
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 30 30",
  width: "21px",
...
const Or = /* @__PURE__ */ F(Er, [["render", jr]]), Rr = {}, Fr = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 48 48",
  width: "21px",
  height: "21px"
...
const Wr = /* @__PURE__ */ F(Rr, [["render", Nr]]), Dr = {}, Hr = {
  xmlns: "http://www.w3.org/2000/svg",
  width: "21",
  height: "21",
...
const Gr = /* @__PURE__ */ F(Dr, [["render", Ur]]), Zr = {}, qr = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 48 48",
  width: "21px",
  height: "21px"
...
const Kr = /* @__PURE__ */ F(Zr, [["render", Yr]]), Jr = {}, Xr = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 48 48",
  width: "21px",
  height: "21px"
...
const eo = /* @__PURE__ */ F(Jr, [["render", Qr]]), to = {}, ao = {
  xmlns: "http://www.w3.org/2000/svg",
  width: "21",
  height: "21",
  viewBox: "0 0 256 256"
...
function no(a, t) {
  return y(), x("svg", ao, t[0] || (t[0] = [
    ...
    T("path", { d: "M128 36C70.562 36 24 72.713 24 118c0 29.279 19.466 54.97 48.748 69.477-1.593 5.494-10.237 35.344-10.581 37.689 0 0-.207 1.762.934 2.434s2.483.15 2.483.15c3.272-.457 37.943-24.811 43.944-29.04 5.995.849 12.168 1.29 18.472 1.29 57.438 0 104-36.712 104-82 0-45.287-46.562-82-104-82z" }, null, -1),
    T("path", {
      fill: "#FFE812",
...
const ro = /* @__PURE__ */ F(to, [["render", no]]), oo = {}, io = {
  width: "21",
  height: "21",
  viewBox: "0 0 512 512",
  fill: "none",
...
const so = /* @__PURE__ */ F(oo, [["render", lo]]), co = {}, po = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 48 48",
  width: "21px",
  height: "21px"
...
const Kt = /* @__PURE__ */ F(co, [["render", uo]]), fo = {}, ho = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 48 48",
  width: "21px",
  height: "21px",
...
const mo = /* @__PURE__ */ F(fo, [["render", go]]), vo = {}, bo = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 48 48",
  width: "21px",
  height: "21px"
...
const yo = /* @__PURE__ */ F(vo, [["render", _o]]), wo = {}, Co = {
  width: "21",
  height: "21",
  viewBox: "0 0 512 512",
  fill: "none",
...
const ko = /* @__PURE__ */ F(wo, [["render", So]]), $o = {}, Bo = {
  width: "21",
  height: "21",
  viewBox: "0 0 512 512",
  fill: "none",
...
const To = /* @__PURE__ */ F($o, [["render", Lo]]), Io = {}, Mo = {
  width: "21",
  height: "21",
  viewBox: "0 0 512 512",
  fill: "none",
...
const Ao = /* @__PURE__ */ F(Io, [["render", xo]]), zo = {}, Po = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 48 48",
  width: "21",
  height: "21"
...
const Vo = /* @__PURE__ */ F(zo, [["render", Eo]]), jo = /* @__PURE__ */ W({
  __name: "Icons",
  props: {
    name: {}
  },
  ...
  setup({ supabaseClient: a }, { slots: t }) {
    ...
    return Jt(async () => {
      ...
      var o;
      return Bn("div", null, (o = t == null ? void 0 : t.default) == null ? void 0 : o.call(t));
    };
  }
}), bt = (a) => {
  const t = z(null), n = (r) => {
  ...
  setup(a) {
    const t = a, { supabaseUser: n } = bt(t.supabaseClient), r = z(""), o = z(!1), { authView: l } = Be(de), m = R(() => t.socialLayout === "vertical"), d = R(() => l.value === "magic_link" ? "sign_in" : l.value), p = R(
      () => {
        var h;
      ...
      let b = null;
      if (u) {
        const { data: _, error: L } = await t.supabaseClient.auth.linkIdentity({
          provider: h,
          options: c
        });
        b = L;
      } else if (t.useOAuthPopup) {
        const { data: _, error: L } = await t.supabaseClient.auth.signInWithOAuth({
          provider: h,
          options: { ...c, skipBrowserRedirect: !0 }
        });
        if (b = L, !L && (_ != null && _.url)) {
          const H = window.open(
            _.url,
            "supabase-oauth",
            t.popupWindowFeatures ?? "width=500,height=650"
          ), { data: j } = t.supabaseClient.auth.onAuthStateChange(
            (O) => {
              O === "SIGNED_IN" && (H == null || H.close(), j.subscription.unsubscribe(), clearInterval(te), o.value = !1);
            }
          ), te = setInterval(() => {
            H != null && H.closed && (clearInterval(te), j.subscription.unsubscribe(), o.value = !1);
          }, 500);
          return;
        }
      } else {
    ...
    return (h, u) => h.providers && h.providers.length > 0 ? (y(), x(Fe, { key: 0 }, [
      A(v(ne), {
        ...
        default: $(() => [
          A(v(ne), {
            ...
            default: $(() => [
              (y(!0), x(Fe, null, Ln(h.providers, (c) => (y(), B(v($e), {
                key: c,
                color: "default",
                loading: o.value,
                onClick: K(() => s(c), ["prevent"]),
                appearance: h.appearance
              }, {
                icon: $(() => [
      ...
      h.onlyThirdPartyProviders ? P("", !0) : (y(), B(v(ur), {
        key: 0,
        appearance: h.appearance
      }, null, 8, ["appearance"]))
    ], 64)) : P("", !0);
  ...
  setup(a) {
    const t = a, { supabaseUser: n } = bt(t.supabaseClient), r = z(""), o = z(""), l = z(""), m = z(!1), { authView: d, setAuthView: p } = Be(de), s = R(
      () => {
        var h;
        return (h = t.i18n) == null ? void 0 : h[d.value];
      }
        ...
        default: $(() => [
                ...
                T("div", null, [
                  A(v(pe), {
                    ...
                    default: $(() => {
                      var b;
                      return [
                        I(M((b = s.value) == null ? void 0 : b.email_input_label), 1)
                      ];
                    }),
                    _: 1
                  }, 8, ["appearance"]),
          ...
          A(v($e), {
            ...
            default: $(() => {
              var c, b;
              return [
                I(M(m.value ? (c = s.value) == null ? void 0 : c.loading_button_label : (b = s.value) == null ? void 0 : b.button_label), 1)
              ];
            }),
            _: 1
          }, 8, ["loading", "appearance"]),
          h.showLinks ? (y(), B(v(be), {
            key: 0,
            href: "#auth-sign-in",
            appearance: h.appearance,
            onClick: u[1] || (u[1] = K((c) => v(p)(v(q).SIGN_IN), ["prevent"]))
          }, {
            default: $(() => {
              var c, b;
              return [
                I(M((b = (c = h.i18n) == null ? void 0 : c.sign_in) == null ? void 0 : b.link_text), 1)
              ];
            }),
            _: 1
          }, 8, ["appearance"])) : P("", !0)
  ...
  setup(a) {
    const t = a, n = z(""), r = z(""), o = z(""), l = z(!1), { authView: m, setAuthView: d } = Be(de), p = R(
      () => {
        var g;
          ...
          return [
            T("div", null, [
              A(v(pe), {
                ...
                default: $(() => {
                  var c;
                  return [
                    I(M((c = p.value) == null ? void 0 : c.email_label), 1)
                  ];
                }),
                _: 1
              }, 8, ["appearance"]),
            ...
            A(v($e), {
              ...
              default: $(() => {
                var c, b;
                return [
                  I(M(l.value ? (c = p.value) == null ? void 0 : c.loading_button_label : (b = p.value) == null ? void 0 : b.button_label), 1)
                ];
              }),
              _: 1
            }, 8, ["loading", "appearance"]),
            g.showLinks ? (y(), B(v(be), {
              key: 0,
              href: "#auth-sign-in",
              appearance: g.appearance,
              onClick: h[1] || (h[1] = K((c) => v(d)(v(q).SIGN_IN), ["prevent"]))
            }, {
              default: $(() => {
                var c, b;
                return [
                  I(M((b = (c = g.i18n) == null ? void 0 : c.sign_in) == null ? void 0 : b.link_text), 1)
                ];
              }),
              _: 1
            }, 8, ["appearance"])) : P("", !0)
  ...
  setup(a) {
    const t = a, n = z(""), r = z(""), o = z(""), l = z(!1), { authView: m } = Be(de), d = R(
      () => {
        var s;
          ...
          return [
            T("div", null, [
              A(v(pe), {
                ...
                default: $(() => {
                  var u;
                  return [
                    I(M((u = d.value) == null ? void 0 : u.password_label), 1)
                  ];
                }),
                _: 1
              }, 8, ["appearance"]),
            ...
            A(v($e), {
              ...
              default: $(() => {
                var u, c;
                return [
                  I(M(l.value ? (u = d.value) == null ? void 0 : u.loading_button_label : (c = d.value) == null ? void 0 : c.button_label), 1)
                ];
              }),
              _: 1
            }, 8, ["loading", "appearance"])
  ...
  setup(a) {
    const t = a, n = z(""), r = z(""), o = z(""), l = z(""), m = z(""), d = z(!1), { authView: p, setAuthView: s } = Be(de), g = R(
      () => {
        var u;
          ...
          return [
            ["sms", "phone_change"].includes(u.otpType) ? (y(), x("div", Go, [
              A(v(pe), {
                ...
                default: $(() => {
                  var _;
                  return [
                    I(M((_ = g.value) == null ? void 0 : _.phone_input_label), 1)
                  ];
                }),
                _: 1
              }, 8, ["appearance"]),
              ...
              A(v(pe), {
                ...
                default: $(() => {
                  var _;
                  return [
                    I(M((_ = g.value) == null ? void 0 : _.email_input_label), 1)
                  ];
                }),
                _: 1
              }, 8, ["appearance"]),
            ...
            T("div", null, [
              A(v(pe), {
                ...
                default: $(() => {
                  var _;
                  return [
                    I(M((_ = g.value) == null ? void 0 : _.token_input_label), 1)
                  ];
                }),
                _: 1
              }, 8, ["appearance"]),
            ...
            A(v($e), {
              ...
              default: $(() => {
                var _, L;
                return [
                  I(M(d.value ? (_ = g.value) == null ? void 0 : _.loading_button_label : (L = g.value) == null ? void 0 : L.button_label), 1)
                ];
              }),
              _: 1
            }, 8, ["loading", "appearance"]),
            u.showLinks ? (y(), B(v(be), {
              key: 2,
              href: "#auth-sign-in",
              appearance: u.appearance,
              onClick: c[3] || (c[3] = K((_) => v(s)(v(q).SIGN_IN), ["prevent"]))
            }, {
              default: $(() => {
                var _, L;
                return [
                  I(M((L = (_ = u.i18n) == null ? void 0 : _.sign_in) == null ? void 0 : L.link_text), 1)
                ];
              }),
              _: 1
            }, 8, ["appearance"])) : P("", !0)
  ...
  setup(a) {
    const t = a;
    bt(t.supabaseClient);
    const n = z(""), r = z(""), o = z(!1), { authView: l, setAuthView: m } = Be(de), d = R(
      () => {
        var s;
        ...
        default: $(() => [
          A(v($e), {
            ...
            default: $(() => {
              var h, u;
              return [
                I(M(o.value ? (h = d.value) == null ? void 0 : h.loading_button_label : (u = d.value) == null ? void 0 : u.button_label), 1)
              ];
            }),
            _: 1
          }, 8, ["loading", "appearance"])
  ...
  setup(a, { emit: t }) {
    ...
    const m = R(() => {
      var h;
      const s = Ke(xn), g = Ke((h = n == null ? void 0 : n.localization) == null ? void 0 : h.variables);
      return ht(s, g ?? {});
    }), d = R(() => o.value === "sign_in" || o.value === "sign_up" || o.value === "magic_link"), p = R(() => {
      var h, u;
    ...
    return mt({ theme: p.value }), dt(
      ...
      default: $(() => [
        d.value ? (y(), B(Oo, {
          ...
          useOAuthPopup: s.useOAuthPopup,
          popupWindowFeatures: s.popupWindowFeatures,
          onlyThirdPartyProviders: s.onlyThirdPartyProviders,
          i18n: m.value
        }, null, 8, ["supabaseClient", "appearance", "providers", "providerScopes", "queryParams", "socialLayout", "redirectTo", "useOAuthPopup", "popupWindowFeatures", "onlyThirdPartyProviders", "i18n"])) : P("", !0),
        s.onlyThirdPartyProviders ? P("", !0) : (y(), x(Fe, { key: 1 }, [
          o.value === "sign_in" || o.value === "sign_up" ? (y(), B(hr, {
            key: 0,
            supabaseClient: s.supabaseClient,
            appearance: s.appearance,
            redirectTo: s.redirectTo,
      ...
      o.value === "forgotten_password" ? (y(), B(Wo, {
        key: 0,
        supabaseClient: s.supabaseClient,
        appearance: s.appearance,
        redirectTo: s.redirectTo,
      ...
      o.value === "update_password" ? (y(), B(Ho, {
        key: 1,
        supabaseClient: s.supabaseClient,
        appearance: s.appearance,
        i18n: m.value
      }, null, 8, ["supabaseClient", "appearance", "i18n"])) : P("", !0),
      o.value === "verify_otp" ? (y(), B(qo, {
        key: 2,
        supabaseClient: s.supabaseClient,
        appearance: s.appearance,
        otpType: s.otpType,
      ...
      o.value === "anonymous_sign_in" ? (y(), B(Ko, {
        key: 3,
        supabaseClient: s.supabaseClient,
        appearance: s.appearance,
        i18n: m.value,
