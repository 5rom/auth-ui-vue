import { defineComponent as te, useAttrs as ra, computed as K, openBlock as T, createBlock as F, resolveDynamicComponent as sa, mergeProps as Ue, unref as E, withCtx as M, renderSlot as We, createElementBlock as j, normalizeClass as Rt, normalizeStyle as Oi, ref as W, createElementVNode as D, withModifiers as ge, inject as Jn, watch as Ma, createVNode as U, createTextVNode as V, toDisplayString as B, createCommentVNode as Y, createStaticVNode as Fa, onMounted as qt, provide as Xn, h as Zt, Fragment as na, renderList as Ii, getCurrentInstance as Jt, onUnmounted as Li, shallowRef as Ai, Text as Mi } from "vue";
var be = {
  SIGN_IN: "sign_in",
  SIGN_UP: "sign_up",
  ...
  SIGN_IN: be.SIGN_IN,
  SIGN_UP: be.SIGN_UP,
  FORGOTTEN_PASSWORD: be.FORGOTTEN_PASSWORD,
  MAGIC_LINK: be.MAGIC_LINK,
  UPDATE_PASSWORD: be.UPDATE_PASSWORD,
  // ui
  anchor: "ui-anchor",
  button: "ui-button",
...
var hn, Z = "colors", me = "sizes", N = "space", zi = { gap: N, gridGap: N, columnGap: N, gridColumnGap: N, rowGap: N, gridRowGap: N, inset: N, insetBlock: N, insetBlockEnd: N, insetBlockStart: N, insetInline: N, insetInlineEnd: N, insetInlineStart: N, margin: N, marginTop: N, marginRight: N, marginBottom: N, marginLeft: N, marginBlock: N, marginBlockEnd: N, marginBlockStart: N, marginInline: N, marginInlineEnd: N, marginInlineStart: N, padding: N, paddingTop: N, paddingRight: N, paddingBottom: N, paddingLeft: N, paddingBlock: N, paddingBlockEnd: N, paddingBlockStart: N, paddingInline: N, paddingInlineEnd: N, paddingInlineStart: N, top: N, right: N, bottom: N, left: N, scrollMargin: N, scrollMarginTop: N, scrollMarginRight: N, scrollMarginBottom: N, scrollMarginLeft: N, scrollMarginX: N, scrollMarginY: N, scrollMarginBlock: N, scrollMarginBlockEnd: N, scrollMarginBlockStart: N, scrollMarginInline: N, scrollMarginInlineEnd: N, scrollMarginInlineStart: N, scrollPadding: N, scrollPaddingTop: N, scrollPaddingRight: N, scrollPaddingBottom: N, scrollPaddingLeft: N, scrollPaddingX: N, scrollPaddingY: N, scrollPaddingBlock: N, scrollPaddingBlockEnd: N, scrollPaddingBlockStart: N, scrollPaddingInline: N, scrollPaddingInlineEnd: N, scrollPaddingInlineStart: N, fontSize: "fontSizes", background: Z, backgroundColor: Z, backgroundImage: Z, borderImage: Z, border: Z, borderBlock: Z, borderBlockEnd: Z, borderBlockStart: Z, borderBottom: Z, borderBottomColor: Z, borderColor: Z, borderInline: Z, borderInlineEnd: Z, borderInlineStart: Z, borderLeft: Z, borderLeftColor: Z, borderRight: Z, borderRightColor: Z, borderTop: Z, borderTopColor: Z, caretColor: Z, color: Z, columnRuleColor: Z, fill: Z, outline: Z, outlineColor: Z, stroke: Z, textDecorationColor: Z, fontFamily: "fonts", fontWeight: "fontWeights", lineHeight: "lineHeights", letterSpacing: "letterSpacings", blockSize: me, minBlockSize: me, maxBlockSize: me, inlineSize: me, minInlineSize: me, maxInlineSize: me, width: me, minWidth: me, maxWidth: me, height: me, minHeight: me, maxHeight: me, flexBasis: me, gridTemplateColumns: me, gridTemplateRows: me, borderWidth: "borderWidths", borderTopWidth: "borderWidths", borderRightWidth: "borderWidths", borderBottomWidth: "borderWidths", borderLeftWidth: "borderWidths", borderStyle: "borderStyles", borderTopStyle: "borderStyles", borderRightStyle: "borderStyles", borderBottomStyle: "borderStyles", borderLeftStyle: "borderStyles", borderRadius: "radii", borderTopLeftRadius: "radii", borderTopRightRadius: "radii", borderBottomRightRadius: "radii", borderBottomLeftRadius: "radii", boxShadow: "shadows", textShadow: "shadows", transition: "transitions", zIndex: "zIndices" }, Fi = (e, a) => typeof a == "function" ? { "()": Function.prototype.toString.call(a) } : a, ja = () => {
  ...
  for (const a in e)
    return !0;
  return !1;
}, { hasOwnProperty: ji } = Object.prototype, Ft = (e) => e.includes("-") ? e : e.replace(/[A-Z]/g, (a) => "-" + a.toLowerCase()), $i = /\s+(?![^()]*\))/, va = (e) => (a) => e(...typeof a == "string" ? String(a).split($i) : [a]), wn = { appearance: (e) => ({ WebkitAppearance: e, appearance: e }), backfaceVisibility: (e) => ({ WebkitBackfaceVisibility: e, backfaceVisibility: e }), backdropFilter: (e) => ({ WebkitBackdropFilter: e, backdropFilter: e }), backgroundClip: (e) => ({ WebkitBackgroundClip: e, backgroundClip: e }), boxDecorationBreak: (e) => ({ WebkitBoxDecorationBreak: e, boxDecorationBreak: e }), clipPath: (e) => ({ WebkitClipPath: e, clipPath: e }), content: (e) => ({ content: e.includes('"') || e.includes("'") || /^([A-Za-z]+\([^]*|[^]*-quote|inherit|initial|none|normal|revert|unset)$/.test(e) ? e : `"${e}"` }), hyphens: (e) => ({ WebkitHyphens: e, hyphens: e }), maskImage: (e) => ({ WebkitMaskImage: e, maskImage: e }), maskSize: (e) => ({ WebkitMaskSize: e, maskSize: e }), tabSize: (e) => ({ MozTabSize: e, tabSize: e }), textSizeAdjust: (e) => ({ WebkitTextSizeAdjust: e, textSizeAdjust: e }), userSelect: (e) => ({ WebkitUserSelect: e, userSelect: e }), marginBlock: va((e, a) => ({ marginBlockStart: e, marginBlockEnd: a || e })), marginInline: va((e, a) => ({ marginInlineStart: e, marginInlineEnd: a || e })), maxSize: va((e, a) => ({ maxBlockSize: e, maxInlineSize: a || e })), minSize: va((e, a) => ({ minBlockSize: e, minInlineSize: a || e })), paddingBlock: va((e, a) => ({ paddingBlockStart: e, paddingBlockEnd: a || e })), paddingInline: va((e, a) => ({ paddingInlineStart: e, paddingInlineEnd: a || e })) }, Mt = /([\d.]+)([^]*)/, Vi = (e, a) => e.length ? e.reduce((t, n) => (t.push(...a.map((l) => l.includes("&") ? l.replace(/&/g, /[ +>|~]/.test(n) && /&.*&/.test(l) ? `:is(${n})` : n) : n + " " + l)), t), []) : a, Bi = (e, a) => e in Ui && typeof a == "string" ? a.replace(/^((?:[^]*[^\w-])?)(fit-content|stretch)((?:[^\w-][^]*)?)$/, (t, n, l, o) => n + (l === "stretch" ? `-moz-available${o};${Ft(e)}:${n}-webkit-fill-available` : `-moz-fit-content${o};${Ft(e)}:${n}fit-content`) + o) : String(a), Ui = { blockSize: 1, height: 1, inlineSize: 1, maxBlockSize: 1, maxHeight: 1, maxInlineSize: 1, maxWidth: 1, minBlockSize: 1, minHeight: 1, minInlineSize: 1, minWidth: 1, width: 1 }, ze = (e) => e ? e + "-" : "", Qn = (e, a, t) => e.replace(/([+-])?((?:\d+(?:\.\d*)?|\.\d+)(?:[Ee][+-]?\d+)?)?(\$|--)([$\w-]+)/g, (n, l, o, s, u) => s == "$" == !!o ? n : (l || s == "--" ? "calc(" : "") + "var(--" + (s === "$" ? ze(a) + (u.includes("$") ? "" : ze(t)) + u.replace(/\$/g, "-") : u) + ")" + (l || s == "--" ? "*" + (l || "") + (o || "1") + ")" : "")), Wi = /\s*,\s*(?![^()]*\))/, Hi = Object.prototype.toString, wa = (e, a, t, n, l) => {
  let o, s, u;
  const r = (c, m, p) => {
    let d, _;
    const f = (w) => {
      for (d in w) {
        const k = d.charCodeAt(0) === 64, L = k && Array.isArray(w[d]) ? w[d] : [w[d]];
        for (_ of L) {
  ...
  const t = () => {
    ...
    return [].map.call(l, (o, s) => {
      ...
      if (l[s - 1] && (r = l[s - 1].cssText).startsWith("--sxs")) {
        if (!o.cssRules.length)
          return "";
        for (const c in a.rules)
          if (a.rules[c].group === o)
            return `--sxs{--sxs:${[...a.rules[c].cache].join(" ")}}${u}`;
    ...
    for (const u of l)
      if (Ki(u)) {
        for (let r = 0, c = u.cssRules; c[r]; ++r) {
          const m = Object(c[r]);
          if (m.type !== 1)
            continue;
          const p = Object(c[r + 1]);
          if (p.type !== 4)
            continue;
          ++r;
          const { cssText: d } = m;
          if (!d.startsWith("--sxs"))
            continue;
          const _ = d.slice(14, -3).trim().split(/\s+/), f = Aa[_[0]];
          f && (a || (a = { sheet: u, reset: n, rules: {}, toString: t }), a.rules[f] = { group: p, index: r, cache: new Set(_) });
        }
        if (a)
          break;
      }
    if (!a) {
      const u = (r, c) => ({ type: c, cssRules: [], insertRule(m, p) {
        this.cssRules.splice(p, 0, u(m, { import: 3, undefined: 1 }[(m.toLowerCase().match(/^@([a-z]+)/) || [])[1]] || 4));
      }, get cssText() {
    ...
    for (let u = Aa.length - 1; u >= 0; --u) {
      const r = Aa[u];
      if (!s[r]) {
        const c = Aa[u + 1], m = s[c] ? s[c].index : o.cssRules.length;
  ...
  const o = `${ze(l.prefix)}c-${la(n)}`, s = [], u = [], r = /* @__PURE__ */ Object.create(null), c = [];
  for (const d in t)
    r[d] = String(t[d]);
  if (typeof e == "object" && e)
    for (const d in e) {
      m = r, p = d, ji.call(m, p) || (r[d] = "undefined");
      const _ = e[d];
      for (const f in _) {
        const w = { [d]: String(f) };
        String(f) === "undefined" && c.push(d);
        const x = _[f], h = [w, x, !vn(x)];
        s.push(h);
      }
    }
  var m, p;
  ...
  const [n, l, o, s] = eo(a.composers), u = typeof a.type == "function" || a.type.$$typeof ? ((p) => {
    function d() {
    ...
    return d[Oa] = [], d.rules = {}, Aa.forEach((_) => d.rules[_] = { apply: (f) => d[Oa].push([_, f]) }), d;
  })(t) : null, r = (u || t).rules, c = `.${n}${l.length > 1 ? `:where(.${l.slice(1).join(".")})` : ""}`, m = (p) => {
    p = typeof p == "object" && p || ao;
    const { css: d, ..._ } = p, f = {};
    for (const h in o)
      if (delete _[h], h in p) {
        let k = p[h];
        typeof k == "object" && k ? f[h] = { "@initial": o[h], ...k } : (k = String(k), f[h] = k !== "undefined" || s.has(h) ? k : o[h]);
      } else
        f[h] = o[h];
    const w = /* @__PURE__ */ new Set([...l]);
    for (const [h, k, L, S] of a.composers) {
      t.rules.styled.cache.has(h) || (t.rules.styled.cache.add(h), wa(k, [`.${h}`], [], e, (z) => {
        r.styled.apply(z);
      }));
      const P = En(L, f, e.media), A = En(S, f, e.media, !0);
      for (const z of P)
        if (z !== void 0)
          for (const [R, C, J] of z) {
            const ne = `${h}-${la(C)}-${R}`;
            w.add(ne);
            const ee = (J ? t.rules.resonevar : t.rules.onevar).cache, ye = J ? r.resonevar : r.onevar;
            ee.has(ne) || (ee.add(ne), wa(C, [`.${ne}`], [], e, (Ae) => {
              ye.apply(Ae);
            }));
          }
      for (const z of A)
        if (z !== void 0)
          for (const [R, C] of z) {
            const J = `${h}-${la(C)}-${R}`;
            w.add(J), t.rules.allvar.cache.has(J) || (t.rules.allvar.cache.add(J), wa(C, [`.${J}`], [], e, (ne) => {
              r.allvar.apply(ne);
            }));
          }
    }
    ...
    for (const h of String(p.className || "").trim().split(/\s+/))
      h && w.add(h);
    const x = _.className = [...w].join(" ");
    return { type: a.type, className: x, selector: c, props: _, toString: () => x, deferredInjector: u };
  };
  return Xt(m, { className: n, selector: c, [et]: a, toString: () => (t.rules.styled.cache.has(n) || m(), n) });
}, eo = (e) => {
  let a = "";
  const t = [], n = {}, l = [];
  for (const [o, , , , s, u] of e) {
    ...
    for (const r in s) {
      const c = s[r];
      (n[r] === void 0 || c !== "undefined" || u.includes(c)) && (n[r] = c);
    }
  }
            ...
            continue e;
          {
            ...
            for (const x in d) {
              if (p === String(d[x])) {
                if (x !== "@initial") {
                  const h = x.slice(1);
                  (f = f || []).push(h in t ? t[h] : x.replace(/^@media ?/, "")), m = !0;
                }
                c += w, _ = !0;
              }
              ++w;
            }
            if (f && f.length && (s = { ["@media " + f.join(", ")]: s }), !_)
              continue e;
          }
        }
      }
      (l[c] = l[c] || []).push([n ? "cv" : `${r}-${o[r]}`, s, m]);
    }
  return l;
}, ao = {}, to = ja(), no = (e, a) => to(e, () => (...t) => {
  const n = () => {
    for (let l of t) {
      l = typeof l == "object" && l || {};
      let o = la(l);
...
}, ro = ja(), so = (e, a) => ro(e, () => (t, n) => {
  n = typeof t == "object" && t || Object(n);
  const l = `.${t = (t = typeof t == "string" ? t : "") || `${ze(e.prefix)}t-${la(n)}`}`, o = {}, s = [];
  for (const r in n) {
    o[r] = {};
    for (const c in n[r]) {
      const m = `--${ze(e.prefix)}${r}-${c}`, p = Qn(String(n[r][c]), e.prefix, r);
      o[r][c] = new oo(c, p, r, e.prefix), s.push(`${m}:${p}`);
    }
  }
  const u = () => {
  ...
  const t = _o(e, (n) => {
    a = !0;
    const l = "prefix" in (n = typeof n == "object" && n || {}) ? String(n.prefix) : "", o = typeof n.media == "object" && n.media || {}, s = typeof n.root == "object" ? n.root || null : globalThis.document || null, u = typeof n.theme == "object" && n.theme || {}, r = { prefix: l, media: o, theme: u, themeMap: typeof n.themeMap == "object" && n.themeMap || { ...zi }, utils: typeof n.utils == "object" && n.utils || {} }, c = Yi(s), m = { css: Ji(r, c), globalCss: no(r, c), keyframes: io(r, c), createTheme: so(r, c), reset() {
      c.reset(), m.theme.toString();
    }, theme: {}, sheet: c, config: r, prefix: l, getCssText: c.toString, toString: c.toString };
    return String(m.theme = m.createTheme(u)), m;
  });
  return a || t.reset(), t;
}, el = () => hn || (hn = jt()), uo = (...e) => el().createTheme(...e), Le = (...e) => el().css(...e), Xa = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {};
function po(e) {
...
tt.exports;
(function(e, a) {
  var t = 200, n = "__lodash_hash_undefined__", l = 9007199254740991, o = "[object Arguments]", s = "[object Array]", u = "[object Boolean]", r = "[object Date]", c = "[object Error]", m = "[object Function]", p = "[object GeneratorFunction]", d = "[object Map]", _ = "[object Number]", f = "[object Object]", w = "[object Promise]", x = "[object RegExp]", h = "[object Set]", k = "[object String]", L = "[object Symbol]", S = "[object WeakMap]", P = "[object ArrayBuffer]", A = "[object DataView]", z = "[object Float32Array]", R = "[object Float64Array]", C = "[object Int8Array]", J = "[object Int16Array]", ne = "[object Int32Array]", ee = "[object Uint8Array]", ye = "[object Uint8ClampedArray]", Ae = "[object Uint16Array]", Ye = "[object Uint32Array]", Ea = /[\\^$.*+?()[\]{}|]/g, qe = /\w*$/, Ze = /^\[object .+?Constructor\]$/, ct = /^(?:0|[1-9]\d*)$/, q = {};
  q[o] = q[s] = q[P] = q[A] = q[u] = q[r] = q[z] = q[R] = q[C] = q[J] = q[ne] = q[d] = q[_] = q[f] = q[x] = q[h] = q[k] = q[L] = q[ee] = q[ye] = q[Ae] = q[Ye] = !0, q[c] = q[m] = q[S] = !1;
  var mt = typeof Xa == "object" && Xa && Xa.Object === Object && Xa, Me = typeof self == "object" && self && self.Object === Object && self, Ee = mt || Me || Function("return this")(), $a = a && !a.nodeType && a, Va = $a && !0 && e && !e.nodeType && e, bt = Va && Va.exports === $a;
  function ft(i, b) {
  ...
  function gt(i, b) {
    for (var v = -1, O = i ? i.length : 0; ++v < O && b(i[v], v, i) !== !1; )
      ;
    return i;
  }
  function ht(i, b) {
    for (var v = -1, O = b.length, se = i.length; ++v < O; )
      i[se + v] = b[v];
    return i;
  }
  function Ba(i, b, v, O) {
    var se = -1, ce = i ? i.length : 0;
    for (O && ce && (v = i[++se]); ++se < ce; )
      v = b(v, i[se], se, i);
    return v;
  }
  function vt(i, b) {
  ...
  var kt = Array.prototype, yt = Function.prototype, pa = Object.prototype, Sa = Ee["__core-js_shared__"], Ha = function() {
    var i = /[^.]+$/.exec(Sa && Sa.keys && Sa.keys.IE_PROTO || "");
    return i ? "Symbol(src)_1." + i : "";
  }(), Ga = yt.toString, Ne = pa.hasOwnProperty, ca = pa.toString, ae = RegExp(
    "^" + Ga.call(Ne).replace(Ea, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), g = bt ? Ee.Buffer : void 0, y = Ee.Symbol, $ = Ee.Uint8Array, X = xa(Object.getPrototypeOf, Object), Oe = Object.create, ma = pa.propertyIsEnumerable, $e = kt.splice, Ie = Object.getOwnPropertySymbols, Et = g ? g.isBuffer : void 0, Ka = xa(Object.keys, Object), xt = ga(Ee, "DataView"), Ca = ga(Ee, "Map"), Tt = ga(Ee, "Promise"), St = ga(Ee, "Set"), Ct = ga(Ee, "WeakMap"), Na = ga(Object, "create"), Cl = Qe(xt), Nl = Qe(Ca), Ol = Qe(Tt), Il = Qe(St), Ll = Qe(Ct), ln = y ? y.prototype : void 0, on = ln ? ln.valueOf : void 0;
  function Je(i) {
    var b = -1, v = i ? i.length : 0;
    for (this.clear(); ++b < v; ) {
      var O = i[b];
      this.set(O[0], O[1]);
    }
  ...
  function Pl(i) {
    ...
    return Ne.call(b, i) ? b[i] : void 0;
  }
  function Rl(i) {
    var b = this.__data__;
    return Na ? b[i] !== void 0 : Ne.call(b, i);
  }
  function Dl(i, b) {
    var v = this.__data__;
    return v[i] = Na && b === void 0 ? n : b, this;
  }
  ...
  function Fl(i) {
    var b = this.__data__, v = Ya(b, i);
    if (v < 0)
      return !1;
    var O = b.length - 1;
    return v == O ? b.pop() : $e.call(b, v, 1), !0;
  }
  function jl(i) {
    var b = this.__data__, v = Ya(b, i);
  ...
  function Vl(i, b) {
    ...
    return O < 0 ? v.push([i, b]) : v[O][1] = b, this;
  }
  Pe.prototype.clear = zl, Pe.prototype.delete = Fl, Pe.prototype.get = jl, Pe.prototype.has = $l, Pe.prototype.set = Vl;
  function ba(i) {
    var b = -1, v = i ? i.length : 0;
    for (this.clear(); ++b < v; ) {
      var O = i[b];
  ...
  function Gl(i, b) {
    return qa(this, i).set(i, b), this;
  }
  ba.prototype.clear = Bl, ba.prototype.delete = Ul, ba.prototype.get = Wl, ba.prototype.has = Hl, ba.prototype.set = Gl;
  function fa(i) {
  ...
  function Jl(i, b) {
    ...
    if (v instanceof Pe) {
      var O = v.__data__;
      if (!Ca || O.length < t - 1)
        return O.push([i, b]), this;
      v = this.__data__ = new ba(O);
    }
    return v.set(i, b), this;
  }
  fa.prototype.clear = Kl, fa.prototype.delete = Yl, fa.prototype.get = ql, fa.prototype.has = Zl, fa.prototype.set = Jl;
  function Xl(i, b) {
    var v = It(i) || yi(i) ? vt(i.length, String) : [], O = v.length, se = !!O;
    for (var ce in i)
      (b || Ne.call(i, ce)) && !(se && (ce == "length" || hi(ce, O))) && v.push(ce);
    return v;
  }
  function rn(i, b, v) {
    var O = i[b];
    (!(Ne.call(i, b) && dn(O, v)) || v === void 0 && !(b in i)) && (i[b] = v);
  }
  function Ya(i, b) {
  ...
  function Ql(i, b) {
    return i && sn(b, Lt(b), i);
  }
  function Nt(i, b, v, O, se, ce, xe) {
    var he;
    if (O && (he = ce ? O(i, se, ce, xe) : O(i)), he !== void 0)
      return he;
    if (!Za(i))
      return i;
    var mn = It(i);
    ...
    return gt(gn || i, function(At, Ja) {
      gn && (Ja = At, At = i[Ja]), rn(he, Ja, Nt(At, b, v, O, Ja, i, xe));
    }), he;
  }
  function ei(i) {
    return Za(i) ? Oe(i) : {};
  ...
  function li(i) {
    ...
    for (var v in Object(i))
      Ne.call(i, v) && v != "constructor" && b.push(v);
    return b;
  }
  function ii(i, b) {
    if (b)
  ...
  function Ot(i) {
    ...
    return new $(b).set(new $(i)), b;
  }
  function oi(i, b) {
    var v = b ? Ot(i.buffer) : i.buffer;
    return new i.constructor(v, i.byteOffset, i.byteLength);
  }
  function ri(i, b, v) {
    var O = b ? v(Wa(i), !0) : Wa(i);
    return Ba(O, ft, new i.constructor());
  }
  function si(i) {
    var b = new i.constructor(i.source, qe.exec(i));
    return b.lastIndex = i.lastIndex, b;
  }
  function _i(i, b, v) {
    var O = b ? v(Ta(i), !0) : Ta(i);
    return Ba(O, nn, new i.constructor());
  }
  function ui(i) {
  ...
  function sn(i, b, v, O) {
    v || (v = {});
    for (var se = -1, ce = b.length; ++se < ce; ) {
      var xe = b[se], he = O ? O(v[xe], i[xe], xe, v, i) : void 0;
      rn(v, xe, he === void 0 ? i[xe] : he);
    }
    return v;
  }
  function ci(i, b) {
  ...
  function qa(i, b) {
    var v = i.__data__;
    return vi(b) ? v[typeof b == "string" ? "string" : "hash"] : v.map;
  }
  function ga(i, b) {
    var v = wt(i, b);
    return ni(v) ? v : void 0;
  }
  var _n = Ie ? xa(Ie, Object) : Ci, Xe = ti;
  (xt && Xe(new xt(new ArrayBuffer(1))) != A || Ca && Xe(new Ca()) != d || Tt && Xe(Tt.resolve()) != w || St && Xe(new St()) != h || Ct && Xe(new Ct()) != S) && (Xe = function(i) {
    var b = ca.call(i), v = b == f ? i.constructor : void 0, O = v ? Qe(v) : void 0;
    if (O)
      switch (O) {
        case Cl:
          return A;
  ...
  function bi(i) {
    var b = i.length, v = i.constructor(b);
    return b && typeof i[0] == "string" && Ne.call(i, "index") && (v.index = i.index, v.input = i.input), v;
  }
  function fi(i) {
  ...
  function hi(i, b) {
    return b = b ?? l, !!b && (typeof i == "number" || ct.test(i)) && i > -1 && i % 1 == 0 && i < b;
  }
  function vi(i) {
    var b = typeof i;
  ...
  function un(i) {
    var b = i && i.constructor, v = typeof b == "function" && b.prototype || pa;
    return i === v;
  }
  function Qe(i) {
    if (i != null) {
  ...
  function yi(i) {
    return Ei(i) && Ne.call(i, "callee") && (!ma.call(i, "callee") || ca.call(i) == o);
  }
  var It = Array.isArray;
  function pn(i) {
    return i != null && Ti(i.length) && !cn(i);
  }
  function Ei(i) {
    return Si(i) && pn(i);
  }
...
var co = tt.exports;
const Ia = /* @__PURE__ */ po(co), Ge = Symbol("AuthView"), mo = Symbol("UserContextProvider"), bo = /* @__PURE__ */ te({
  ...
  setup(e) {
    ...
    return (l, o) => (T(), F(sa("div"), Ue(E(t), { class: n.value }), {
      default: M(() => [
        We(l.$slots, "default")
      ]),
      _: 3
  ...
  setup(e) {
    ...
    }), m = K(() => t().toString()), p = K(() => l().toString());
    return (d, _) => {
      var f, w, x, h;
      return d.type === "password" ? (T(), j("div", {
        key: 0,
        class: Rt(m.value)
      }, [
        D("input", Ue(E(s), {
          type: r.value,
          class: c.value,
          style: (w = (f = d.appearance) == null ? void 0 : f.style) == null ? void 0 : w.input,
          value: d.modelValue,
      ...
      ], 2)) : (T(), j("input", Ue({ key: 1 }, E(s), {
        type: d.type,
        class: c.value,
        style: (h = (x = d.appearance) == null ? void 0 : x.style) == null ? void 0 : h.input,
        value: d.modelValue,
...
function He(e, a) {
  ...
  const t = e.message ?? "";
  if (a) {
    const n = e.code || Eo[t.toLowerCase().trim()];
    if (n && a[n])
      return a[n];
  }
  return t;
}
const xo = ["id"], To = /* @__PURE__ */ te({
  __name: "EmailAuth",
  props: {
    appearance: {},
    supabaseClient: {},
  ...
  setup(e, { emit: a }) {
    const t = e, n = W(""), l = W(""), o = W(""), s = W(""), u = W(!1), { authView: r, setAuthView: c } = da(Ge), m = K(
      () => {
        var _;
      ...
      var f, w, x, h;
      switch (o.value = "", s.value = "", u.value = !0, p("auth:submit", {
        email: n.value,
        password: l.value,
        view: r.value
      }), r.value) {
        case "sign_in":
          ...
          k && (o.value = He(k, (f = t.i18n) == null ? void 0 : f.errors), p("auth:error", k)), u.value = !1;
          break;
        case "sign_up":
          let L = {
            emailRedirectTo: t.redirectTo
          };
          t.additionalData && (L.data = t.additionalData);
          const {
          ...
          A ? (o.value = He(A, (w = t.i18n) == null ? void 0 : w.errors), p("auth:error", A)) : S && !P && (s.value = (h = (x = t.i18n) == null ? void 0 : x.sign_up) == null ? void 0 : h.confirmation_text), u.value = !1;
      }
    };
    return Ma(
      () => r.value,
        ...
        default: M(() => [
                ...
                D("div", null, [
                  U(E(Be), {
                    ...
                    default: M(() => {
                      var L;
                      return [
                        V(B((L = m.value) == null ? void 0 : L.email_label), 1)
                      ];
                    }),
                    _: 1
                  }, 8, ["appearance"]),
                ...
                D("div", null, [
                  U(E(Be), {
                    ...
                    default: M(() => {
                      var L;
                      return [
                        V(B((L = m.value) == null ? void 0 : L.password_label), 1)
                      ];
                    }),
                    _: 1
                  }, 8, ["appearance"]),
                  U(E(Ve), {
                    ...
                    name: "password",
                    modelValue: l.value,
                    "onUpdate:modelValue": f[1] || (f[1] = (L) => l.value = L),
                    placeholder: (x = m.value) == null ? void 0 : x.password_input_placeholder,
          ...
          U(E(ua), {
            ...
            default: M(() => {
              var w, x;
              return [
                V(B(u.value ? (w = m.value) == null ? void 0 : w.loading_button_label : (x = m.value) == null ? void 0 : x.button_label), 1)
              ];
            }),
            _: 1
          }, 8, ["loading", "appearance"]),
          _.showLinks ? (T(), F(E(Ce), {
            key: 0,
            direction: "vertical",
            gap: "small",
            appearance: _.appearance
            ...
            default: M(() => [
              E(r) === E(be).SIGN_IN && _.magicLink ? (T(), F(E(ta), {
                key: 0,
                href: "#auth-magic-link",
                appearance: _.appearance,
                onClick: f[2] || (f[2] = ge((w) => E(c)(E(be).MAGIC_LINK), ["prevent"]))
              }, {
                default: M(() => {
                  var w, x;
                  return [
                    V(B((x = (w = _.i18n) == null ? void 0 : w.magic_link) == null ? void 0 : x.link_text), 1)
                  ];
                }),
                _: 1
              }, 8, ["appearance"])) : Y("", !0),
              E(r) === E(be).SIGN_IN ? (T(), F(E(ta), {
                key: 1,
                href: "#auth-forgot-password",
                appearance: _.appearance,
                onClick: f[3] || (f[3] = ge((w) => E(c)(E(be).FORGOTTEN_PASSWORD), ["prevent"]))
              }, {
                default: M(() => {
                  var w, x;
                  return [
                    V(B((x = (w = _.i18n) == null ? void 0 : w.forgotten_password) == null ? void 0 : x.link_text), 1)
                  ];
                }),
                _: 1
              }, 8, ["appearance"])) : Y("", !0),
              E(r) === E(be).SIGN_IN ? (T(), F(E(ta), {
                ...
                href: "#auth-sign-up",
                appearance: _.appearance,
                onClick: f[4] || (f[4] = ge((w) => E(c)(E(be).SIGN_UP), ["prevent"]))
              }, {
                default: M(() => {
                  var w, x;
                  return [
                    V(B((x = (w = _.i18n) == null ? void 0 : w.sign_up) == null ? void 0 : x.link_text), 1)
                  ];
                }),
                _: 1
              }, 8, ["appearance"])) : (T(), F(E(ta), {
                key: 3,
                href: "#auth-sign-in",
                appearance: _.appearance,
                onClick: f[5] || (f[5] = ge((w) => E(c)(E(be).SIGN_IN), ["prevent"]))
              }, {
                default: M(() => {
                  var w, x;
                  return [
                    V(B((x = (w = _.i18n) == null ? void 0 : w.sign_in) == null ? void 0 : x.link_text), 1)
                  ];
                }),
                _: 1
              }, 8, ["appearance"]))
...
const Oo = /* @__PURE__ */ re(So, [["render", No]]), Io = {}, Lo = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 48 48",
  width: "21px",
  height: "21px"
...
const Mo = /* @__PURE__ */ re(Io, [["render", Ao]]), Po = {}, Ro = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 48 48",
  width: "21px",
  height: "21px"
...
const zo = /* @__PURE__ */ re(Po, [["render", Do]]), Fo = {}, jo = {
  fill: "gray",
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  width: "21px",
...
const Vo = /* @__PURE__ */ re(Fo, [["render", $o]]), Bo = {}, Uo = {
  xmlns: "http://www.w3.org/2000/svg",
  width: "21.34",
  height: "21",
  viewBox: "0 0 256 384"
...
const Ho = /* @__PURE__ */ re(Bo, [["render", Wo]]), Go = {}, Ko = {
  fill: "gray",
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 30 30",
  width: "21px",
...
const dr = /* @__PURE__ */ re(sr, [["render", ur]]), pr = {}, cr = {
  xmlns: "http://www.w3.org/2000/svg",
  width: "21",
  height: "21",
  viewBox: "0 0 256 256"
...
const br = /* @__PURE__ */ re(pr, [["render", mr]]), fr = {}, gr = {
  width: "21",
  height: "21",
  viewBox: "0 0 512 512",
  fill: "none",
...
const vr = /* @__PURE__ */ re(fr, [["render", hr]]), wr = {}, kr = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 48 48",
  width: "21px",
  height: "21px"
...
const xn = /* @__PURE__ */ re(wr, [["render", yr]]), Er = {}, xr = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 48 48",
  width: "21px",
  height: "21px",
...
const Sr = /* @__PURE__ */ re(Er, [["render", Tr]]), Cr = {}, Nr = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 48 48",
  width: "21px",
  height: "21px"
...
const Ir = /* @__PURE__ */ re(Cr, [["render", Or]]), Lr = {}, Ar = {
  width: "21",
  height: "21",
  viewBox: "0 0 512 512",
  fill: "none",
...
const Fr = /* @__PURE__ */ re(Rr, [["render", zr]]), jr = {}, $r = {
  width: "21",
  height: "21",
  viewBox: "0 0 512 512",
  fill: "none",
...
const Br = /* @__PURE__ */ re(jr, [["render", Vr]]), Ur = {}, Wr = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 48 48",
  width: "21",
  height: "21"
...
const Gr = /* @__PURE__ */ re(Ur, [["render", Hr]]), Kr = /* @__PURE__ */ te({
  __name: "Icons",
  props: {
    name: {}
  },
  ...
  setup(e) {
    const a = e, { supabaseUser: t } = Qt(a.supabaseClient), n = W(""), l = W(!1), { authView: o } = da(Ge), s = K(() => a.socialLayout === "vertical"), u = K(() => o.value === "magic_link" ? "sign_in" : o.value), r = K(
      () => {
        var p;
        return (p = a.i18n) == null ? void 0 : p[u.value];
      }
    ), c = async (p) => {
      var w, x, h;
      n.value = "", l.value = !0;
      const d = (w = t.value) == null ? void 0 : w.is_anonymous, _ = {
        ...
        scopes: (x = a.providerScopes) == null ? void 0 : x[p],
        queryParams: a.queryParams
      };
      let f = null;
      if (d) {
        const { data: k, error: L } = await a.supabaseClient.auth.linkIdentity({
          provider: p,
          options: _
        });
        f = L;
      } else if (a.useOAuthPopup) {
        const { data: k, error: L } = await a.supabaseClient.auth.signInWithOAuth({
          provider: p,
          options: { ..._, skipBrowserRedirect: !0 }
        });
        if (f = L, !L && (k != null && k.url)) {
          const S = window.open(
            k.url,
            "supabase-oauth",
      ...
      f && (n.value = He(f, (h = a.i18n) == null ? void 0 : h.errors)), l.value = !1;
    };
    function m(p) {
      const d = p.toLowerCase();
      return p.charAt(0).toUpperCase() + d.slice(1);
    }
    return (p, d) => p.providers && p.providers.length > 0 ? (T(), j(na, { key: 0 }, [
      U(E(Ce), {
        gap: "large",
        direction: "vertical",
        ...
        default: M(() => [
          U(E(Ce), {
            ...
            default: M(() => [
              (T(!0), j(na, null, Ii(p.providers, (_) => (T(), F(E(ua), {
                key: _,
                color: "default",
                loading: l.value,
                onClick: ge(() => c(_), ["prevent"]),
                appearance: p.appearance
              }, {
                icon: M(() => [
                  U(E(Kr), { name: _ }, null, 8, ["name"])
                ]),
                default: M(() => {
                  var f, w;
                  return [
                    s.value ? (T(), j(na, { key: 0 }, [
                      V(B(E(Di)(
                        (w = (f = r.value) == null ? void 0 : f.social_provider_text) == null ? void 0 : w.replace("_oidc", ""),
                        {
      ...
      p.onlyThirdPartyProviders ? Y("", !0) : (T(), F(E(go), {
        key: 0,
        appearance: p.appearance
      }, null, 8, ["appearance"]))
    ], 64)) : Y("", !0);
  ...
  setup(e) {
    const a = e, { supabaseUser: t } = Qt(a.supabaseClient), n = W(""), l = W(""), o = W(""), s = W(!1), { authView: u, setAuthView: r } = da(Ge), c = K(
      () => {
        var p;
        return (p = a.i18n) == null ? void 0 : p[u.value];
      }
      ...
      const d = (f = t.value) == null ? void 0 : f.is_anonymous;
      let _ = null;
      if (d) {
      ...
      _ ? l.value = He(_, (w = a.i18n) == null ? void 0 : w.errors) : o.value = (h = (x = a.i18n) == null ? void 0 : x.magic_link) == null ? void 0 : h.confirmation_text, s.value = !1;
    };
    return (p, d) => (T(), j("form", {
      id: `auth-${E(u)}`,
        ...
        default: M(() => [
                ...
                D("div", null, [
                  U(E(Be), {
                    ...
                    default: M(() => {
                      var f;
                      return [
                        V(B((f = c.value) == null ? void 0 : f.email_input_label), 1)
                      ];
                    }),
                    _: 1
                  }, 8, ["appearance"]),
                  U(E(Ve), {
                    ...
                    autoComplete: "email",
                    autofocus: "",
                    placeholder: (_ = c.value) == null ? void 0 : _.email_input_placeholder,
                    appearance: p.appearance,
                    modelValue: n.value,
          ...
          U(E(ua), {
            ...
            default: M(() => {
              var _, f;
              return [
                V(B(s.value ? (_ = c.value) == null ? void 0 : _.loading_button_label : (f = c.value) == null ? void 0 : f.button_label), 1)
              ];
            }),
            _: 1
          }, 8, ["loading", "appearance"]),
          p.showLinks ? (T(), F(E(ta), {
            key: 0,
            href: "#auth-sign-in",
            appearance: p.appearance,
            onClick: d[1] || (d[1] = ge((_) => E(r)(E(be).SIGN_IN), ["prevent"]))
          }, {
            default: M(() => {
              var _, f;
              return [
                V(B((f = (_ = p.i18n) == null ? void 0 : _.sign_in) == null ? void 0 : f.link_text), 1)
              ];
            }),
            _: 1
          }, 8, ["appearance"])) : Y("", !0)
  ...
  setup(e) {
    const a = e, t = W(""), n = W(""), l = W(""), o = W(!1), { authView: s, setAuthView: u } = da(Ge), r = K(
      ...
      const { error: p } = await a.supabaseClient.auth.resetPasswordForEmail(t.value, {
        redirectTo: a.redirectTo,
        captchaToken: (d = a.options) == null ? void 0 : d.captchaToken
      });
      p ? n.value = He(p, (_ = a.i18n) == null ? void 0 : _.errors) : l.value = (w = (f = a.i18n) == null ? void 0 : f.forgotten_password) == null ? void 0 : w.confirmation_text, o.value = !1;
    };
    return (m, p) => (T(), j("form", {
      id: `auth-${E(s)}`,
            ...
            D("div", null, [
              U(E(Be), {
                ...
                default: M(() => {
                  var _;
                  return [
                    V(B((_ = r.value) == null ? void 0 : _.email_label), 1)
                  ];
                }),
                _: 1
              }, 8, ["appearance"]),
              U(E(Ve), {
                ...
                appearance: m.appearance,
                modelValue: t.value,
                "onUpdate:modelValue": p[0] || (p[0] = (_) => t.value = _)
              }, null, 8, ["placeholder", "appearance", "modelValue"])
            ]),
            U(E(ua), {
              type: "submit",
              ...
              default: M(() => {
                var _, f;
                return [
                  V(B(o.value ? (_ = r.value) == null ? void 0 : _.loading_button_label : (f = r.value) == null ? void 0 : f.button_label), 1)
                ];
              }),
              _: 1
            }, 8, ["loading", "appearance"]),
            m.showLinks ? (T(), F(E(ta), {
              key: 0,
              href: "#auth-sign-in",
              appearance: m.appearance,
              onClick: p[1] || (p[1] = ge((_) => E(u)(E(be).SIGN_IN), ["prevent"]))
            }, {
              default: M(() => {
                var _, f;
                return [
                  V(B((f = (_ = m.i18n) == null ? void 0 : _.sign_in) == null ? void 0 : f.link_text), 1)
                ];
              }),
              _: 1
            }, 8, ["appearance"])) : Y("", !0)
  ...
  setup(e) {
    const a = e, t = W(""), n = W(""), l = W(""), o = W(!1), { authView: s } = da(Ge), u = K(
      () => {
        var c;
        return (c = a.i18n) == null ? void 0 : c[s.value];
      }
    ), r = async (c) => {
      var p, d, _;
      n.value = "", l.value = "", o.value = !0;
      ...
      m ? n.value = He(m, (p = a.i18n) == null ? void 0 : p.errors) : l.value = (_ = (d = a.i18n) == null ? void 0 : d.update_password) == null ? void 0 : _.confirmation_text, o.value = !1;
    };
    return (c, m) => (T(), j("form", {
      id: `auth-${E(s)}`,
          ...
          return [
            D("div", null, [
              U(E(Be), {
                ...
                default: M(() => {
                  var f;
                  return [
                    V(B((f = u.value) == null ? void 0 : f.password_label), 1)
                  ];
                }),
                _: 1
              }, 8, ["appearance"]),
              U(E(Ve), {
                ...
                name: "password",
                autofocus: "",
                placeholder: (p = u.value) == null ? void 0 : p.password_input_placeholder,
                appearance: c.appearance,
                modelValue: t.value,
                "onUpdate:modelValue": m[0] || (m[0] = (f) => t.value = f),
                showLabel: (d = c.i18n) == null ? void 0 : d.password_show,
                hideLabel: (_ = c.i18n) == null ? void 0 : _.password_hide
            ...
            U(E(ua), {
              ...
              default: M(() => {
                var f, w;
                return [
                  V(B(o.value ? (f = u.value) == null ? void 0 : f.loading_button_label : (w = u.value) == null ? void 0 : w.button_label), 1)
                ];
              }),
              _: 1
            }, 8, ["loading", "appearance"])
  ...
  setup(e) {
    const a = e, t = W(""), n = W(""), l = W(""), o = W(""), s = W(""), u = W(!1), { authView: r, setAuthView: c } = da(Ge), m = K(
      () => {
        var d;
      ...
      const { error: f } = await a.supabaseClient.auth.verifyOtp(
        _
      );
      f ? o.value = He(f, (w = a.i18n) == null ? void 0 : w.errors) : s.value = (h = (x = a.i18n) == null ? void 0 : x.magic_link) == null ? void 0 : h.confirmation_text, u.value = !1;
    };
    return (d, _) => (T(), j("form", {
      id: `auth-${E(r)}`,
      ...
      U(E(Ce), {
        ...
        default: M(() => {
          var f, w, x;
          return [
            ["sms", "phone_change"].includes(d.otpType) ? (T(), j("div", ts, [
              U(E(Be), {
                htmlFor: "phone",
                appearance: d.appearance
              }, {
                default: M(() => {
                  var h;
                  return [
                    V(B((h = m.value) == null ? void 0 : h.phone_input_label), 1)
                  ];
                }),
                _: 1
              }, 8, ["appearance"]),
              U(E(Ve), {
                ...
                type: "text",
                autofocus: "",
                placeholder: (f = m.value) == null ? void 0 : f.phone_input_placeholder,
                appearance: d.appearance,
                modelValue: n.value,
              ...
              U(E(Be), {
                ...
                default: M(() => {
                  var h;
                  return [
                    V(B((h = m.value) == null ? void 0 : h.email_input_label), 1)
                  ];
                }),
                _: 1
              }, 8, ["appearance"]),
            ...
            D("div", null, [
              U(E(Be), {
                ...
                default: M(() => {
                  var h;
                  return [
                    V(B((h = m.value) == null ? void 0 : h.token_input_label), 1)
                  ];
                }),
                _: 1
              }, 8, ["appearance"]),
              U(E(Ve), {
                ...
                type: "text",
                autofocus: "",
                placeholder: (x = m.value) == null ? void 0 : x.token_input_placeholder,
                appearance: d.appearance,
                modelValue: l.value,
            ...
            U(E(ua), {
              ...
              default: M(() => {
                var h, k;
                return [
                  V(B(u.value ? (h = m.value) == null ? void 0 : h.loading_button_label : (k = m.value) == null ? void 0 : k.button_label), 1)
                ];
              }),
              _: 1
            }, 8, ["loading", "appearance"]),
            d.showLinks ? (T(), F(E(ta), {
              key: 2,
              href: "#auth-sign-in",
              appearance: d.appearance,
              onClick: _[3] || (_[3] = ge((h) => E(c)(E(be).SIGN_IN), ["prevent"]))
            }, {
              default: M(() => {
                var h, k;
                return [
                  V(B((k = (h = d.i18n) == null ? void 0 : h.sign_in) == null ? void 0 : k.link_text), 1)
                ];
              }),
              _: 1
            }, 8, ["appearance"])) : Y("", !0)
  ...
  setup(e) {
    ...
    const t = W(""), n = W(""), l = W(!1), { authView: o, setAuthView: s } = da(Ge), u = K(
      () => {
        var c;
        return (c = a.i18n) == null ? void 0 : c[o.value];
      }
    ), r = async (c) => {
      var _;
      t.value = "", n.value = "", l.value = !0;
      let m = null;
      const { data: p, error: d } = await a.supabaseClient.auth.signInAnonymously(
        ...
        default: M(() => [
          U(E(ua), {
            ...
            default: M(() => {
              var p, d;
              return [
                V(B(l.value ? (p = u.value) == null ? void 0 : p.loading_button_label : (d = u.value) == null ? void 0 : d.button_label), 1)
              ];
            }),
            _: 1
          }, 8, ["loading", "appearance"])
...
const je = (e, a = !1) => a ? Symbol.for(e) : Symbol(e), ss = (e, a, t) => _s({ l: e, k: a, s: t }), _s = (e) => JSON.stringify(e).replace(/\u2028/g, "\\u2028").replace(/\u2029/g, "\\u2029").replace(/\u0027/g, "\\u0027"), de = (e) => typeof e == "number" && isFinite(e), us = (e) => nl(e) === "[object Date]", nt = (e) => nl(e) === "[object RegExp]", st = (e) => G(e) && Object.keys(e).length === 0, pe = Object.assign;
let Tn;
const Pa = () => Tn || (Tn = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : typeof global < "u" ? global : {});
function Sn(e) {
...
const oe = Array.isArray, Q = (e) => typeof e == "function", I = (e) => typeof e == "string", ie = (e) => typeof e == "boolean", H = (e) => e !== null && typeof e == "object", ps = (e) => H(e) && Q(e.then) && Q(e.catch), tl = Object.prototype.toString, nl = (e) => tl.call(e), G = (e) => {
  if (!H(e))
    return !1;
  const a = Object.getPrototypeOf(e);
  return a === null || a.constructor === Object;
}, cs = (e) => e == null ? "" : oe(e) || G(e) && e.toString === tl ? JSON.stringify(e, null, 2) : String(e);
function ms(e, a = "") {
  return e.reduce((t, n, l) => l === 0 ? t + n : t + a + n, "");
}
const Cn = 2;
function bs(e, a = 0, t = e.length) {
  const n = e.split(/\r?\n/);
  let l = 0;
  const o = [];
  for (let s = 0; s < n.length; s++)
    if (l += n[s].length + 1, l >= a) {
      for (let u = s - Cn; u <= s + Cn || t > l; u++) {
        if (u < 0 || u >= n.length)
          continue;
        const r = u + 1;
        ...
        const c = n[u].length;
        if (u === s) {
          const m = a - (l - c) + 1, p = Math.max(1, t > l ? c - m : t - a);
          o.push("   |  " + " ".repeat(m) + "^".repeat(p));
        } else if (u > s) {
          if (t > l) {
            const m = Math.max(Math.min(t - l, c), 1);
            o.push("   |  " + "^".repeat(m));
          }
          l += c + 1;
        }
...
function Cs(e) {
  const a = e.trim();
  return e.charAt(0) === "0" && isNaN(parseInt(e)) ? !1 : xs(a) ? Ts(a) : "*" + a;
}
function Ns(e) {
  const a = [];
  let t = -1, n = 0, l = 0, o, s, u, r, c, m, p;
  const d = [];
  d[
    0
    /* Actions.APPEND */
  ...
  for (; n !== null; )
    if (t++, o = e[t], !(o === "\\" && _())) {
      if (r = Ss(o), p = Ke[n], c = p[r] || p.l || 8, c === 8 || (n = c[0], c[1] !== void 0 && (m = d[c[1]], m && (u = o, m() === !1))))
        return;
      if (n === 7)
        return a;
    }
...
const Ls = (e) => e, As = (e) => "", Ms = "text", Ps = (e) => e.length === 0 ? "" : ms(e), Rs = cs;
function In(e, a) {
...
function Fs(e = {}) {
  const a = e.locale, t = Ds(e), n = H(e.pluralRules) && I(a) && Q(e.pluralRules[a]) ? e.pluralRules[a] : In, l = H(e.pluralRules) && I(a) && Q(e.pluralRules[a]) ? In : void 0, o = (h) => h[n(t, h.length, l)], s = e.list || [], u = (h) => s[h], r = e.named || {};
  ...
  const p = (h) => e.modifiers ? e.modifiers[h] : Ls, d = G(e.processor) && Q(e.processor.normalize) ? e.processor.normalize : Ps, _ = G(e.processor) && Q(e.processor.interpolate) ? e.processor.interpolate : Rs, f = G(e.processor) && I(e.processor.type) ? e.processor.type : Ms, x = {
    list: u,
    named: c,
    plural: o,
    linked: (h, ...k) => {
      const [L, S] = k;
      let P = "text", A = "";
      k.length === 1 ? H(L) ? (A = L.modifier || A, P = L.type || P) : I(L) && (A = L || A) : k.length === 2 && (I(L) && (A = L || A), I(S) && (P = S || P));
      const z = m(h)(x), R = (
...
const ol = ws.__EXTEND_POINT__, ea = _t(ol), fe = {
  NOT_FOUND_KEY: ol,
  // 2
...
function Hs(e, a, t) {
  return [.../* @__PURE__ */ new Set([
    t,
    ...oe(a) ? a : H(a) ? Object.keys(a) : I(a) ? [a] : [t]
  ])];
}
function sl(e, a, t) {
  const n = I(t) ? t : it, l = e;
  ...
  if (!o) {
    ...
    s = I(u) ? [u] : u, oe(s) && An(o, s, !1), l.__localeChainCache.set(n, o);
  }
  return o;
}
function An(e, a, t) {
...
function qs() {
  return {
    upper: (e, a) => a === "text" && I(e) ? e.toUpperCase() : a === "vnode" && H(e) && "__v_isVNode" in e ? e.children.toUpperCase() : e,
    lower: (e, a) => a === "text" && I(e) ? e.toLowerCase() : a === "vnode" && H(e) && "__v_isVNode" in e ? e.children.toLowerCase() : e,
    capitalize: (e, a) => a === "text" && I(e) ? Mn(e) : a === "vnode" && H(e) && "__v_isVNode" in e ? Mn(e.children) : e
  };
}
let Zs, _l;
function Js(e) {
...
let Rn = 0;
function t_(e = {}) {
  const a = Q(e.onWarn) ? e.onWarn : ya, t = I(e.version) ? e.version : Ys, n = I(e.locale) || Q(e.locale) ? e.locale : it, l = Q(n) ? it : n, o = oe(e.fallbackLocale) || G(e.fallbackLocale) || I(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : l, s = G(e.messages) ? e.messages : { [l]: {} }, u = G(e.datetimeFormats) ? e.datetimeFormats : { [l]: {} }, r = G(e.numberFormats) ? e.numberFormats : { [l]: {} }, c = pe({}, e.modifiers || {}, qs()), m = e.pluralRules || {}, p = Q(e.missing) ? e.missing : null, d = ie(e.missingWarn) || nt(e.missingWarn) ? e.missingWarn : !0, _ = ie(e.fallbackWarn) || nt(e.fallbackWarn) ? e.fallbackWarn : !0, f = !!e.fallbackFormat, w = !!e.unresolving, x = Q(e.postTranslation) ? e.postTranslation : null, h = G(e.processor) ? e.processor : null, k = ie(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, L = !!e.escapeParameter, S = Q(e.messageCompiler) ? e.messageCompiler : Zs;
  process.env.NODE_ENV !== "production" && Q(e.messageCompiler) && ll(oa(fe.EXPERIMENTAL_CUSTOM_MESSAGE_COMPILER));
  const P = Q(e.messageResolver) ? e.messageResolver : _l || Os, A = Q(e.localeFallbacker) ? e.localeFallbacker : ul || Hs, z = H(e.fallbackContext) ? e.fallbackContext : void 0, R = e, C = H(R.__datetimeFormatters) ? R.__datetimeFormatters : /* @__PURE__ */ new Map(), J = H(R.__numberFormatters) ? R.__numberFormatters : /* @__PURE__ */ new Map(), ne = H(R.__meta) ? R.__meta : {};
  Rn++;
  const ee = {
    version: t,
    cid: Rn,
  ...
  return ee.datetimeFormats = u, ee.numberFormats = r, ee.__datetimeFormatters = C, ee.__numberFormatters = J, process.env.NODE_ENV !== "production" && (ee.__v_emitter = R.__v_emitter != null ? R.__v_emitter : void 0), (process.env.NODE_ENV !== "production" || __INTLIFY_PROD_DEVTOOLS__) && $s(ee, t, ne), ee;
}
function dt(e, a) {
...
function an(e, a, t, n, l) {
  ...
  if (o !== null) {
    ...
    return process.env.NODE_ENV !== "production" && cl(n, a) && s(oa(fe.NOT_FOUND_KEY, { key: a, locale: t })), a;
}
function La(e, a, t) {
  const n = e;
...
const ka = (e) => H(e) && (e.t === 0 || e.type === 0) && ("b" in e || "body" in e), Dn = () => "", Te = (e) => Q(e);
function zn(e, ...a) {
  const { fallbackFormat: t, postTranslation: n, unresolving: l, messageCompiler: o, fallbackLocale: s, messages: u } = e, [r, c] = $t(...a), m = ie(c.missingWarn) ? c.missingWarn : e.missingWarn, p = ie(c.fallbackWarn) ? c.fallbackWarn : e.fallbackWarn, d = ie(c.escapeParameter) ? c.escapeParameter : e.escapeParameter, _ = !!c.resolvedMessage, f = I(c.default) || ie(c.default) ? ie(c.default) ? o ? r : () => r : c.default : t ? o ? r : () => r : "", w = t || f !== "", x = en(e, c);
  d && l_(c);
  let [h, k, L] = _ ? [
    r,
    x,
    u[x] || {}
  ] : bl(e, r, x, s, p, m), S = h, P = r;
  if (!_ && !(I(S) || ka(S) || Te(S)) && w && (S = f, P = S), !_ && (!(I(S) || ka(S) || Te(S)) || !I(k)))
    return l ? ut : r;
  if (process.env.NODE_ENV !== "production" && I(S) && e.messageCompiler == null)
    return ya(`The message format compilation is not supported in this build. Because message compiler isn't included. You need to pre-compilation all message format. So translate function return '${r}'.`), r;
  let A = !1;
  const z = () => {
    A = !0;
  }, R = Te(S) ? S : fl(e, r, k, S, P, z);
  if (A)
    return S;
  const C = s_(e, k, L, c), J = Fs(C), ne = i_(e, R, J), ee = n ? n(ne, r) : ne;
  if (process.env.NODE_ENV !== "production" || __INTLIFY_PROD_DEVTOOLS__) {
    const ye = {
      timestamp: Date.now(),
      key: I(r) ? r : Te(S) ? S.key : "",
      locale: k || (Te(S) ? S.locale : ""),
      format: I(S) ? S : Te(S) ? S.source : "",
      message: ee
    };
    ye.meta = pe({}, e.__meta, /* @__PURE__ */ e_() || {}), Vs(ye);
  }
  return ee;
}
function l_(e) {
  oe(e.list) ? e.list = e.list.map((a) => I(a) ? Sn(a) : a) : H(e.named) && Object.keys(e.named).forEach((a) => {
    I(e.named[a]) && (e.named[a] = Sn(e.named[a]));
  });
}
function bl(e, a, t, n, l, o) {
  const { messages: s, onWarn: u, messageResolver: r, localeFallbacker: c } = e, m = c(e, n, t);
  let p = {}, d, _ = null, f = t, w = null;
  const x = "translate";
  for (let h = 0; h < m.length; h++) {
    if (d = w = m[h], process.env.NODE_ENV !== "production" && t !== d && !ml(t, d) && dt(l, a) && u(oa(fe.FALLBACK_TO_TRANSLATE, {
      key: a,
      target: d
    ...
    p = s[d] || {};
    let k = null, L, S;
    if (process.env.NODE_ENV !== "production" && Fe && (k = window.performance.now(), L = "intlify-message-resolve-start", S = "intlify-message-resolve-end", ke && ke(L)), (_ = r(p, a)) === null && (_ = p[a]), process.env.NODE_ENV !== "production" && Fe) {
      ...
      A && k && _ && A.emit("message-resolve", {
        ...
        time: P - k,
        groupId: `${x}:${a}`
      }), L && S && ke && ia && (ke(S), ia("intlify message resolve", L, S));
    }
    if (I(_) || ka(_) || Te(_))
      break;
    if (!n_(d, m)) {
...
function fl(e, a, t, n, l, o) {
  ...
  let r = null, c, m;
  process.env.NODE_ENV !== "production" && Fe && (r = window.performance.now(), c = "intlify-message-compilation-start", m = "intlify-message-compilation-end", ke && ke(c));
  const p = s(n, o_(e, t, l, n, u, o));
  if (process.env.NODE_ENV !== "production" && Fe) {
    ...
    _ && r && _.emit("message-compilation", {
      ...
      time: d - r,
      groupId: `translate:${a}`
    }), c && m && ke && ia && (ke(m), ia("intlify message compilation", c, m));
  }
  return p.locale = t, p.key = a, p.source = n, p;
}
function i_(e, a, t) {
  let n = null, l, o;
...
function $t(...e) {
  const [a, t, n] = e, l = {};
  if (!I(a) && !de(a) && !Te(a) && !ka(a))
    throw De(ue.INVALID_ARGUMENT);
  const o = de(a) ? String(a) : (Te(a), a);
  return de(t) ? l.plural = t : I(t) ? l.default = t : G(t) && !st(t) ? l.named = t : oe(t) && (l.list = t), de(n) ? l.plural = n : I(n) ? l.default = n : G(n) && pe(l, n), [o, l];
}
  ...
  return {
    ...
    onError: (s) => {
      if (o && o(s), process.env.NODE_ENV !== "production") {
        const u = r_(n), r = `Message compilation error: ${s.message}`, c = s.location && u && bs(u, s.location.start.offset, s.location.end.offset), m = e.__v_emitter;
...
function s_(e, a, t, n) {
  const { modifiers: l, pluralRules: o, messageResolver: s, fallbackLocale: u, fallbackWarn: r, missingWarn: c, fallbackContext: m } = e, d = {
    locale: a,
    modifiers: l,
    pluralRules: o,
    messages: (_) => {
      let f = s(t, _);
      if (f == null && m) {
        const [, , w] = bl(m, _, a, u, r, c);
        f = s(w, _);
      }
      if (I(f) || ka(f)) {
        let w = !1;
        const h = fl(e, _, a, f, _, () => {
          w = !0;
        });
        return w ? Dn : h;
      } else
...
function jn(e, ...a) {
  ...
  if (process.env.NODE_ENV !== "production" && !gl.dateTimeFormat)
    return o(oa(fe.CANNOT_FORMAT_DATE)), ot;
  const [r, c, m, p] = Vt(...a), d = ie(m.missingWarn) ? m.missingWarn : e.missingWarn, _ = ie(m.fallbackWarn) ? m.fallbackWarn : e.fallbackWarn, f = !!m.part, w = en(e, m), x = s(
    e,
    // eslint-disable-line @typescript-eslint/no-explicit-any
    l,
    w
  ...
  if (!I(r) || r === "")
    return new Intl.DateTimeFormat(w, p).format(c);
  let h = {}, k, L = null, S = w, P = null;
  const A = "datetime format";
  for (let C = 0; C < x.length; C++) {
    if (k = P = x[C], process.env.NODE_ENV !== "production" && w !== k && dt(_, r) && o(oa(fe.FALLBACK_TO_DATE_FORMAT, {
      key: r,
      target: k
  ...
  if (!G(L) || !I(k))
    return n ? ut : r;
  let z = `${k}__${r}`;
  st(p) || (z = `${z}__${JSON.stringify(p)}`);
  let R = u.get(z);
  return R || (R = new Intl.DateTimeFormat(k, pe({}, L, p)), u.set(z, R)), f ? R.formatToParts(c) : R.format(c);
}
const hl = [
  "localeMatcher",
  "weekday",
...
function Vt(...e) {
  ...
  if (I(a)) {
    ...
    const c = r[3] ? r[3].trim().startsWith("T") ? `${r[1].trim()}${r[3].trim()}` : `${r[1].trim()}T${r[3].trim()}` : r[1].trim();
    u = new Date(c);
    try {
      u.toISOString();
    } catch {
    ...
    throw De(ue.INVALID_ARGUMENT);
  return I(t) ? o.key = t : G(t) && Object.keys(t).forEach((r) => {
    hl.includes(r) ? s[r] = t[r] : o[r] = t[r];
  }), I(n) ? o.locale = n : G(n) && (s = n), G(l) && (s = l), [o.key || "", u, o, s];
}
function $n(e, a, t) {
  const n = e;
  for (const l in t) {
...
function Vn(e, ...a) {
  ...
  if (process.env.NODE_ENV !== "production" && !gl.numberFormat)
    return o(oa(fe.CANNOT_FORMAT_NUMBER)), ot;
  const [r, c, m, p] = Bt(...a), d = ie(m.missingWarn) ? m.missingWarn : e.missingWarn, _ = ie(m.fallbackWarn) ? m.fallbackWarn : e.fallbackWarn, f = !!m.part, w = en(e, m), x = s(
    e,
    // eslint-disable-line @typescript-eslint/no-explicit-any
    l,
    w
  ...
  if (!I(r) || r === "")
    return new Intl.NumberFormat(w, p).format(c);
  let h = {}, k, L = null, S = w, P = null;
  const A = "number format";
  for (let C = 0; C < x.length; C++) {
    if (k = P = x[C], process.env.NODE_ENV !== "production" && w !== k && dt(_, r) && o(oa(fe.FALLBACK_TO_NUMBER_FORMAT, {
      key: r,
      target: k
    })), process.env.NODE_ENV !== "production" && w !== k) {
      const J = e.__v_emitter;
  ...
  st(p) || (z = `${z}__${JSON.stringify(p)}`);
  let R = u.get(z);
  return R || (R = new Intl.NumberFormat(k, pe({}, L, p)), u.set(z, R)), f ? R.formatToParts(c) : R.format(c);
}
const vl = [
  "localeMatcher",
  "style",
...
const wl = fe.__EXTEND_POINT__, Re = _t(wl), we = {
  FALLBACK_TO_ROOT: wl,
  // 9
...
function Da(e, ...a) {
  return il(e, null, process.env.NODE_ENV !== "production" ? { messages: p_, args: a } : void 0);
}
const p_ = {
...
}, Ut = /* @__PURE__ */ je("__translateVNode"), Wt = /* @__PURE__ */ je("__datetimeParts"), Ht = /* @__PURE__ */ je("__numberParts"), Gt = /* @__PURE__ */ je("__enableEmitter"), Kt = /* @__PURE__ */ je("__disableEmitter"), c_ = je("__setPluralRules"), m_ = /* @__PURE__ */ je("__injectWithOption"), Yt = /* @__PURE__ */ je("__dispose");
function za(e) {
  if (!H(e))
    return e;
  for (const a in e)
      ...
      if (!a.includes("."))
        ...
        for (let s = 0; s < n; s++) {
          if (t[s] in l || (l[t[s]] = {}), !H(l[t[s]])) {
            process.env.NODE_ENV !== "production" && ya(rt(we.IGNORE_OBJ_FLATTEN, {
              key: t[s]
            })), o = !0;
            break;
          }
...
function yl(e, a) {
  ...
  if (oe(n) && n.forEach((u) => {
    if ("locale" in u && "resource" in u) {
      const { locale: r, resource: c } = u;
      r ? (s[r] = s[r] || {}, at(c, s[r])) : at(c, s);
    } else
      I(u) && at(JSON.parse(u), s);
  }), l == null && o)
    for (const u in s)
      lt(s, u) && za(s[u]);
  return s;
...
function b_(e, a, t) {
  ...
  "__i18nGlobal" in t && (n = yl(e.locale.value, {
    messages: n,
...
function Un(e) {
  return U(Mi, null, e, 0);
}
const Wn = "__INTLIFY_META__", Hn = () => [], f_ = () => !1;
let Gn = 0;
function Kn(e) {
...
function h_(e = {}, a) {
  ...
  const c = s(
    // prettier-ignore
    t && r ? t.locale.value : I(e.locale) ? e.locale : it
  ), m = s(
    // prettier-ignore
    t && r ? t.fallbackLocale.value : I(e.fallbackLocale) || oe(e.fallbackLocale) || G(e.fallbackLocale) || e.fallbackLocale === !1 ? e.fallbackLocale : c.value
  ), p = s(yl(c.value, e)), d = s(G(e.datetimeFormats) ? e.datetimeFormats : { [c.value]: {} }), _ = s(G(e.numberFormats) ? e.numberFormats : { [c.value]: {} });
  let f = t ? t.missingWarn : ie(e.missingWarn) || nt(e.missingWarn) ? e.missingWarn : !0, w = t ? t.fallbackWarn : ie(e.fallbackWarn) || nt(e.fallbackWarn) ? e.fallbackWarn : !0, x = t ? t.fallbackRoot : ie(e.fallbackRoot) ? e.fallbackRoot : !0, h = !!e.fallbackFormat, k = Q(e.missing) ? e.missing : null, L = Q(e.missing) ? Kn(e.missing) : null, S = Q(e.postTranslation) ? e.postTranslation : null, P = t ? t.warnHtmlMessage : ie(e.warnHtmlMessage) ? e.warnHtmlMessage : !0, A = !!e.escapeParameter;
  const z = t ? t.modifiers : G(e.modifiers) ? e.modifiers : {};
  let R = e.pluralRules || t && t.pluralRules, C;
  C = (() => {
    l && Pn(null);
    const g = {
      version: __,
    ...
    g.datetimeFormats = d.value, g.numberFormats = _.value, g.__datetimeFormatters = G(C) ? C.__datetimeFormatters : void 0, g.__numberFormatters = G(C) ? C.__numberFormatters : void 0, process.env.NODE_ENV !== "production" && (g.__v_emitter = G(C) ? C.__v_emitter : void 0);
    const y = t_(g);
    return l && Pn(y), y;
  })(), La(C, c.value, m.value);
  function ne() {
    return [
      c.value,
      m.value,
  ...
  const ee = K({
    get: () => c.value,
    set: (g) => {
      c.value = g, C.locale = c.value;
    }
  }), ye = K({
    get: () => m.value,
    set: (g) => {
      m.value = g, C.fallbackLocale = m.value, La(C, c.value, g);
    }
  }), Ae = K(() => p.value), Ye = /* @__PURE__ */ K(() => d.value), Ea = /* @__PURE__ */ K(() => _.value);
  function qe() {
    return Q(S) ? S : null;
  }
  function Ze(g) {
    S = g, C.postTranslation = g;
  }
  function ct() {
    return k;
  }
  function q(g) {
    g !== null && (L = Kn(g)), k = g, C.missing = L;
  }
  function mt(g, y) {
    return g !== "translate" || !y.resolvedMessage;
  }
  const Me = (g, y, $, X, Oe, ma) => {
    ne();
    let $e;
    try {
      process.env.NODE_ENV !== "production" || __INTLIFY_PROD_DEVTOOLS__, l || (C.fallbackContext = t ? a_() : void 0), $e = g(C);
    } finally {
      process.env.NODE_ENV !== "production" || __INTLIFY_PROD_DEVTOOLS__, l || (C.fallbackContext = void 0);
    }
    if ($ !== "translate exists" && // for not `te` (e.g `t`)
    de($e) && $e === ut || $ === "translate exists" && !$e) {
      const [Ie, Et] = y();
      if (process.env.NODE_ENV !== "production" && t && I(Ie) && mt($, Et) && (x && (dt(w, Ie) || cl(f, Ie)) && ya(rt(we.FALLBACK_TO_ROOT, {
        key: Ie,
        type: $
      })), process.env.NODE_ENV !== "production")) {
        const { __v_emitter: Ka } = C;
        Ka && x && Ka.emit("fallback", {
          type: $,
          key: Ie,
          to: "global",
          groupId: `${$}:${Ie}`
  ...
  function Ee(...g) {
    return Me((y) => Reflect.apply(zn, null, [y, ...g]), () => $t(...g), "translate", (y) => Reflect.apply(y.t, y, [...g]), (y) => y, (y) => I(y));
  }
  function $a(...g) {
    const [y, $, X] = g;
    if (X && !H(X))
      throw Da(le.INVALID_ARGUMENT);
    return Ee(y, $, pe({ resolvedMessage: !0 }, X || {}));
  }
  function Va(...g) {
    return Me((y) => Reflect.apply(jn, null, [y, ...g]), () => Vt(...g), "datetime format", (y) => Reflect.apply(y.d, y, [...g]), () => ot, (y) => I(y));
  }
  function bt(...g) {
    return Me((y) => Reflect.apply(Vn, null, [y, ...g]), () => Bt(...g), "number format", (y) => Reflect.apply(y.n, y, [...g]), () => ot, (y) => I(y));
  }
  function ft(g) {
    return g.map((y) => I(y) || de(y) || ie(y) ? Un(String(y)) : y);
  }
  const gt = {
    normalize: ft,
    interpolate: (g) => g,
  ...
  function ht(...g) {
    return Me(
      (y) => {
        ...
        const X = y;
        try {
          X.processor = gt, $ = Reflect.apply(zn, null, [X, ...g]);
        } finally {
          X.processor = null;
        }
        return $;
  ...
  function Ua(g, y) {
    return Me(() => {
      if (!g)
        return !1;
      const $ = I(y) ? y : c.value, X = Ta($), Oe = C.messageResolver(X, g);
      return u ? Oe != null : ka(Oe) || Te(Oe) || I(Oe);
    }, () => [g], "translate exists", ($) => Reflect.apply($.te, $, [g, y]), f_, ($) => ie($));
  }
  function Wa(g) {
    let y = null;
    const $ = sl(C, m.value, c.value);
    for (let X = 0; X < $.length; X++) {
      const Oe = p.value[$[X]] || {}, ma = C.messageResolver(Oe, g);
      if (ma != null) {
        y = ma;
        break;
      }
  ...
  function kt(g, y) {
    ...
    p.value[g] = y, C.messages = p.value;
  }
  function yt(g, y) {
    p.value[g] = p.value[g] || {};
    const $ = { [g]: y };
    if (o)
      for (const X in $)
        lt($, X) && za($[X]);
    y = $[g], at(y, p.value[g]), C.messages = p.value;
  }
  function pa(g) {
    return d.value[g] || {};
  }
  function Sa(g, y) {
    d.value[g] = y, C.datetimeFormats = d.value, $n(C, g, y);
  }
  function Ha(g, y) {
    d.value[g] = pe(d.value[g] || {}, y), C.datetimeFormats = d.value, $n(C, g, y);
  }
  function Ga(g) {
    return _.value[g] || {};
  }
  function Ne(g, y) {
    _.value[g] = y, C.numberFormats = _.value, Bn(C, g, y);
  }
  function ca(g, y) {
    _.value[g] = pe(_.value[g] || {}, y), C.numberFormats = _.value, Bn(C, g, y);
  }
  Gn++, t && Fe && (Ma(t.locale, (g) => {
    r && (c.value = g, C.locale = g, La(C, c.value, m.value));
  }), Ma(t.fallbackLocale, (g) => {
    r && (m.value = g, C.fallbackLocale = g, La(C, c.value, m.value));
  }));
  const ae = {
    id: Gn,
    locale: ee,
    ...
    set inheritLocale(g) {
      r = g, g && t && (c.value = t.locale.value, m.value = t.fallbackLocale.value, La(C, c.value, m.value));
    },
    ...
    set fallbackFormat(g) {
      h = g, C.fallbackFormat = h;
    },
    get warnHtmlMessage() {
      return P;
    },
    set warnHtmlMessage(g) {
      P = g, C.warnHtmlMessage = g;
    },
    get escapeParameter() {
      return A;
    },
    set escapeParameter(g) {
      A = g, C.escapeParameter = g;
    },
    t: Ee,
    getLocaleMessage: Ta,
    setLocaleMessage: kt,
  ...
  return ae.datetimeFormats = Ye, ae.numberFormats = Ea, ae.rt = $a, ae.te = Ua, ae.tm = xa, ae.d = Va, ae.n = bt, ae.getDateTimeFormat = pa, ae.setDateTimeFormat = Sa, ae.mergeDateTimeFormat = Ha, ae.getNumberFormat = Ga, ae.setNumberFormat = Ne, ae.mergeNumberFormat = ca, ae[m_] = n, ae[Ut] = ht, ae[Wt] = vt, ae[Ht] = Ba, process.env.NODE_ENV !== "production" && (ae[Gt] = (g) => {
    C.__v_emitter = g;
  }, ae[Kt] = () => {
...
function Tl(e, a, t, n) {
  ...
  return () => {
    const s = { part: !0 };
    let u = {};
    e.locale && (s.locale = e.locale), I(e.format) ? s.key = e.format : H(e.format) && (I(e.format.key) && (s.key = e.format.key), u = Object.keys(e.format).reduce((d, _) => t.includes(_) ? pe({}, d, { [_]: e.format[_] }) : d, {}));
    const r = n(e.value, s, u);
    let c = [s.key];
    oe(r) ? c = r.map((d, _) => {
      const f = l[d.type], w = f ? f({ [d.type]: d.value, index: _, parts: r }) : [d.value];
      return w_(w) && (w[0].key = `${d.type}-${_}`), w;
    }) : I(r) && (c = [r]);
    const m = pe({}, o), p = I(e.tag) || H(e.tag) ? e.tag : xl();
    return Zt(p, m, c);
  };
}
pe({
...
const k_ = /* @__PURE__ */ je("global-vue-i18n");
function pt(e = {}) {
  const a = Jt();
  if (a == null)
  ...
  const t = y_(a), n = x_(t), l = El(a), o = E_(e, l);
  if (o === "global")
    return b_(n, e, l), n;
  if (o === "parent") {
    let r = T_(t, a, e.__useComponent);
    return r == null && (process.env.NODE_ENV !== "production" && ya(rt(we.NOT_FOUND_PARENT_SCOPE)), r = n), r;
  }
  const s = t;
  let u = s.__getInstance(a);
  if (u == null) {
    const r = pe({}, e);
    "__i18n" in l && (r.__i18n = l.__i18n), n && (r.__root = n), u = h_(r), s.__composerExtend && (u[Yt] = s.__composerExtend(u)), C_(s, a, u), s.__setInstance(a, u);
  }
  return u;
}
function y_(e) {
...
function C_(e, a, t) {
  ...
  qt(() => {
    if (process.env.NODE_ENV !== "production" && a.vnode.el) {
      a.vnode.el.__VUE_I18N__ = t, n = fs();
      const l = t;
      l[Gt] && l[Gt](n), n.on("*", Yn);
    }
  }, a), Li(() => {
...
const pu = /* @__PURE__ */ te({
  ...
  setup(e, { emit: a }) {
    const t = e, n = a, l = W(t.view), o = (p) => {
      n("update:view", p), l.value = p;
    };
    Xn(Ge, {
      authView: l,
      setAuthView: o
    ...
    const s = uu(), u = du(), r = K(() => {
      ...
      const p = Ia(s.value);
      p.errors = Ia(u.value);
      const d = Ia((_ = t == null ? void 0 : t.localization) == null ? void 0 : _.variables);
      return zt(p, d ?? {});
    }), c = K(() => l.value === "sign_in" || l.value === "sign_up" || l.value === "magic_link"), m = K(() => {
      var _, f;
      const p = Ia((_ = t.appearance) == null ? void 0 : _.theme), d = Ia((f = t.appearance) == null ? void 0 : f.variables);
      return zt(
        (p == null ? void 0 : p.default) ?? {},
        (p == null ? void 0 : p[t.theme]) ?? {},
        (d == null ? void 0 : d.default) ?? {},
        (d == null ? void 0 : d[t == null ? void 0 : t.theme]) ?? {}
      );
    });
    return jt({ theme: m.value }), Ma(
      ...
      (p) => {
        ...
        return o(p), () => d.subscription.unsubscribe();
      },
      { deep: !0 }
    ), (p, d) => c.value ? (T(), F(bo, {
      key: 0,
      ...
      default: M(() => [
        c.value ? (T(), F(Yr, {
          ...
          socialLayout: p.socialLayout,
          redirectTo: p.redirectTo,
          useOAuthPopup: p.useOAuthPopup,
          popupWindowFeatures: p.popupWindowFeatures,
          onlyThirdPartyProviders: p.onlyThirdPartyProviders,
          i18n: r.value
        ...
        p.onlyThirdPartyProviders ? Y("", !0) : (T(), j(na, { key: 1 }, [
          l.value === "sign_in" || l.value === "sign_up" ? (T(), F(To, {
            key: 0,
            supabaseClient: p.supabaseClient,
            appearance: p.appearance,
            redirectTo: p.redirectTo,
      ...
      _: 1
    }, 8, ["theme", "appearance"])) : (T(), j(na, { key: 1 }, [
      l.value === "forgotten_password" ? (T(), F(Xr, {
        key: 0,
        supabaseClient: p.supabaseClient,
        appearance: p.appearance,
        redirectTo: p.redirectTo,
      ...
      l.value === "update_password" ? (T(), F(es, {
        key: 1,
        supabaseClient: p.supabaseClient,
        appearance: p.appearance,
        i18n: r.value
      }, null, 8, ["supabaseClient", "appearance", "i18n"])) : Y("", !0),
      l.value === "verify_otp" ? (T(), F(ls, {
        key: 2,
        supabaseClient: p.supabaseClient,
        appearance: p.appearance,
        otpType: p.otpType,
      ...
      l.value === "anonymous_sign_in" ? (T(), F(os, {
        key: 3,
        supabaseClient: p.supabaseClient,
        appearance: p.appearance,
        i18n: r.value,
        anonymouslyCredentials: p.anonymouslyCredentials
