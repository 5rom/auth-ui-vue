...
import { BaseAppearance, I18nVariables, OtpType, ProviderScopes, RedirectTo, SocialLayout, ViewType } from '@supabase/auth-ui-shared';
import { Provider, Session, SignInAnonymouslyCredentials, SupabaseClient, User } from '@supabase/supabase-js';
...
export type AuthProvider = 'apple' | 'azure' | 'bitbucket' | 'discord' | 'facebook' | 'figma' | 'github' | 'gitlab' | 'google' | 'kakao' | 'keycloak' | 'linkedin' | 'linkedin_oidc' | 'notion' | 'slack' | 'spotify' | 'twitch' | 'twitter' | 'workos' | 'zoom';
